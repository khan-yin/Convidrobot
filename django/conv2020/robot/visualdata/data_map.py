...
class ProvinceData():
    ...
    def province_total_data(self):
        ...
        jsonname = ['data/china-data.json','data/data.json','data/heal_data.json','data/dead_data.json']
        filename=[]
        ...
        with open(filename[2], 'w', encoding='utf-8') as f:
            json.dump(heal_data, f, ensure_ascii=False)
        with open(filename[3], 'w', encoding='utf-8') as f:
            json.dump(dead_data, f, ensure_ascii=False)
        return areaTree,virus_data,heal_data,dead_data
