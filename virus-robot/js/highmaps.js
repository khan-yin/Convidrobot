...
(function (R, M) {
    ...
    M(w, "parts/Globals.js", [], function () {
        var d = "undefined" !== typeof R ? R : "undefined" !== typeof window ? window : {}, f = d.document,
            L = d.navigator && d.navigator.userAgent || "",
            F = f && f.createElementNS && !!f.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
            A = /(edge|msie|trident)/i.test(L) && !d.opera, D = -1 !== L.indexOf("Firefox"),
            x = -1 !== L.indexOf("Chrome"), p = D && 4 > parseInt(L.split("Firefox/")[1], 10);
        return {
            product: "Highcharts",
            version: "8.0.0",
    ...
    M(w, "parts/Utilities.js", [w["parts/Globals.js"]], function (d) {
        ...
        function E(b, a, c, e) {
            b = +b || 0;
            a = +a;
            var g = d.defaultOptions.lang, q = (b.toString().split(".")[1] || "").split("e")[0].length,
                l = b.toString().split("e");
            if (-1 === a) a = Math.min(q, 20); else if (!p(a)) a = 2; else if (a && l[1] && 0 > l[1]) {
                var m =
                    a + +l[1];
        ...
        d.timers = [];
        var e = d.charts, c = d.doc, a = d.win;
        d.error = function (b, c, e, m) {
            var g = p(b), q = g ? "Highcharts error #" + b + ": www.highcharts.com/errors/" + b + "/" : b.toString(),
                l = function () {
                    if (c) throw Error(q);
            ...
            e ? d.fireEvent(e, "displayError", {code: b, message: q, params: m}, l) : l()
        };
        d.Fx = function (b, a, c) {
            this.options = a;
            this.elem = b;
        ...
        d.Fx.prototype = {
            dSetter: function () {
                var b = this.paths[0], a = this.paths[1], c = [], e = this.now, d = b.length;
                if (1 === e) c = this.toD; else if (d === a.length && 1 > e) for (; d--;) {
                    var z = parseFloat(b[d]);
                    c[d] = isNaN(z) || "A" === a[d - 4] || "A" === a[d - 5] ? a[d] : e * parseFloat("" + (a[d] - z)) + z
                } else c = a;
                this.elem.attr("d", c, null, !0)
            }, update: function () {
                var b = this.elem, a = this.prop, c = this.now, e = this.options.step;
                if (this[a + "Setter"]) this[a + "Setter"](); else b.attr ? b.element && b.attr(a, c, null, !0) : b.style[a] = c + this.unit;
                e && e.call(b, c, this)
            }, run: function (b,
                              c, e) {
                var g = this, q = g.options, z = function (b) {
                ...
                var a = +new Date, c = this.options, e = this.elem, d = c.complete, z = c.duration, l = c.curAnim;
                if (e.attr && !e.element) b = !1; else if (b || a >= z + this.startTime) {
                    this.now = this.end;
                    this.pos = 1;
                    this.update();
                    var v = l[this.prop] = !0;
                ...
                a = a || "";
                var l = b.startX, v = b.endX,
                    d = -1 < a.indexOf("C"), h = d ? 7 : 3, k, r;
                a = a.split(" ");
                c = c.slice();
                var G = b.isArea, N = G ? 2 : 1;
                d && (g(a), g(c));
                if (l && v) {
                    for (r = 0; r < l.length; r++) if (l[r] === v[0]) {
                        var n = r;
                        break
        ...
        d.merge = function () {
            var b, a = arguments, c = {}, e = function (b, a) {
                "object" !== typeof b && (b = {});
                h(a, function (c, g) {
        ...
        d.createElement = function (b, a, e, m, h) {
            ...
            var g = d.css;
            a && t(b, a);
            h && g(b, {padding: "0", border: "none", margin: "0"});
            e && g(b, e);
            m && m.appendChild(b);
            return b
        };
        ...
        d.formatSingle = function (b, a, c) {
            var g = /\.([0-9])/, e = d.defaultOptions.lang, q = c && c.time || d.time;
        ...
        d.find = Array.prototype.find ? function (b, a) {
            ...
            var c, e = b.length;
            for (c = 0; c < e; c++) if (a(b[c], c)) return b[c]
        };
        d.keys = Object.keys;
        d.stop = function (b, a) {
            for (var c = d.timers.length; c--;) d.timers[c].elem !== b || a && a !== d.timers[c].prop || (d.timers[c].stopped =
                !0)
        };
        h({map: "map", each: "forEach", grep: "filter", reduce: "reduce", some: "some"}, function (b, a) {
            d[a] = function (a) {
        ...
        d.addEvent = function (b, a, c, e) {
            ...
            g && g.call(b, a, c,
                !1);
            m[a] || (m[a] = []);
            m[a].push({fn: c, order: "number" === typeof e.order ? e.order : Infinity});
        ...
        d.removeEvent = function (b, a, c) {
            ...
            function g(c) {
                ...
                if (b.nodeName) {
                    ...
                    h(l, function (b, a) {
                        if (c[a]) for (g = c[a].length; g--;) e(a, c[a][g].fn)
                    })
                }
            }
        ...
        d.fireEvent = function (b, a, e, m) {
            ...
            if (c.createEvent && (b.dispatchEvent || b.fireEvent)) {
                ...
                void 0 === a && (a = []);
                void 0 === c && (c = []);
                var l = 0, m = 0, q = a.length + c.length;
        ...
        d.animate = function (a, c, e) {
            ...
            if (!A(e)) {
                var v = arguments;
                e = {duration: v[2], easing: v[3], complete: v[4]}
            }
        ...
        d.seriesType = function (a, c, e, m, h) {
            var b = d.getOptions(), g = d.seriesTypes;
        ...
        return {
            animObject: function (a) {
                return A(a) ? d.merge(a) : {duration: a ? 500 : 0}
            },
            arrayMax: function (a) {
            ...
            wrap: function (a, c, e) {
                var b = a[c];
                a[c] = function () {
                    var a = Array.prototype.slice.call(arguments), c = arguments, g = this;
                    g.proceed = function () {
    ...
    M(w, "parts/Color.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var L = f.isNumber, F = f.pInt, A = d.merge;
        d.Color = function (f) {
        ...
        d.Color.prototype = {
            parsers: [{
                ...
                f.toLowerCase ? f.toLowerCase() : ""] || f) && f.stops) this.stops = f.stops.map(function (f) {
                    ...
                    if (!x) for (p = this.parsers.length; p-- && !x;) {
                ...
                if (this.stops) this.stops.forEach(function (f) {
                    f.brighten(d)
                }); else if (L(d) && 0 !== d) for (f = 0; 3 > f; f++) p[f] += F(255 * d), 0 > p[f] && (p[f] = 0), 255 < p[f] && (p[f] = 255);
                return this
    ...
    M(w, "parts/SvgRenderer.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var L = f.animObject, F = f.attr, A = f.defined, D = f.destroyObjectProperties, x = f.erase, p = f.extend,
            H = f.isArray, u = f.isNumber,
            t = f.isObject, y = f.isString, k = f.objectEach, n = f.pick, E = f.pInt, h = f.splat, e = d.addEvent,
            c = d.animate, a = d.charts, b = d.color, g = d.css, q = d.createElement, m = d.deg2rad, C = d.doc,
            z = d.hasTouch, l = d.isFirefox, v = d.isMS, B = d.isWebKit, I = d.merge, J = d.noop, r = d.removeEvent,
            G = d.stop, N = d.svg, U = d.SVG_NS, S = d.symbolSizes, W = d.win;
        ...
        p(O.prototype, {
            ...
            animate: function (a, b, e) {
                ...
                0 !== r.duration ? (e && (r.complete = e), c(this, a, r)) : (this.attr(a, void 0, e), k(a, function (a, b) {
                    r.step && r.step.call(this, a, {prop: b, pos: 1})
                }, this));
                return this
            },
            complexColor: function (a, b, c) {
                var e = this.renderer, r, g, l, G, K, m, P, v, q, h, Q, B = [], z;
                d.fireEvent(this.renderer,
                    "complexColor", {args: arguments}, function () {
                        ...
                        g && (l = a[g], K = e.gradients, P = a.stops, h = c.radialReference, H(l) && (a[g] = l = {
                        ...
                        }), "radialGradient" === g && h && !A(l.gradientUnits) && (G = l, l = I(l, e.getRadialAttr(h, G), {gradientUnits: "userSpaceOnUse"})), k(l, function (a, b) {
                            "id" !== b && B.push(b, a)
                        }), k(P, function (a) {
                            B.push(a)
                            ...
                            a = e.createElement("stop").attr({offset: a[0], "stop-color": v, "stop-opacity": q}).add(m);
                            m.stops.push(a)
            ...
            applyTextOutline: function (a) {
                ...
                if ((c = a[0]) && "none" !== c && d.svg) {
                    ...
                    a.forEach(function (a, g) {
                        ...
                        a = a.cloneNode(1);
                        F(a, {
                            "class": "highcharts-text-outline", fill: e, stroke: e, "stroke-width": c,
            ...
            attr: function (a, b, c, e) {
                var r = this.element, g, l = this, m, K, P = this.symbolCustomAttribs;
            ...
            css: function (a) {
                var b = this.styles, c = {}, e = this.element, r = "", l = !b,
                ...
                if (l) {
                    b && (a = p(b, c));
                    if (a) if (null === a.width || "auto" === a.width) delete this.textWidth; else if ("text" === e.nodeName.toLowerCase() && a.width) var m = this.textWidth = E(a.width);
                    this.styles = a;
            ...
            strokeWidth: function () {
                ...
                if (a.indexOf("px") === a.length - 2) b = E(a); else if ("" !== a) {
                    var c = C.createElementNS(U, "rect");
                    F(c, {width: a, "stroke-width": 0});
            ...
            updateTransform: function () {
                var a = this.translateX || 0, b = this.translateY || 0, c = this.scaleX, e = this.scaleY,
                    r = this.inverted, g = this.rotation,
                    l = this.matrix, G = this.element;
            ...
            getBBox: function (a, b) {
                var c, e = this.renderer, r = this.element, g = this.styles, l = this.textStr, G, d = e.cache,
                    v = e.cacheKeys, q = r.namespaceURI === this.SVG_NS;
            ...
            destroy: function () {
                var a = this, b = a.element || {}, c = a.renderer,
                    e = c.isSVG && "SPAN" === b.nodeName && a.parentGroup, r = b.ownerSVGElement, g = a.clipPath;
            ...
            setTextPath: function (a, b) {
                var c = this.element, e = {textAnchor: "text-anchor"}, r = !1, g = this.textPathWrapper, l = !g;
                b = I(!0, {enabled: !0, attributes: {dy: -5, startOffset: "50%", textAnchor: "middle"}}, b);
                var G = b.attributes;
                if (a && b && b.enabled) {
                    ...
                    if (l) for (a = c.getElementsByTagName("tspan"); a.length;) a[0].setAttribute("y", 0), u(G.dx) && a[0].setAttribute("x", -G.dx), m.appendChild(a[0]);
                    r && g.add({element: this.text ? this.text.element : c});
            ...
            zIndexSetter: function (a, b) {
                var c = this.renderer, e = this.parentGroup, r = (e || c).element || c.box, g = this.element, l = !1;
                c = r === c.box;
                var G = this.added;
                var m;
                ...
                if (G) {
                    ...
                    for (m = b.length - 1; 0 <= m && !l; m--) {
                        ...
                        var d = !A(G);
                        if (e !== g) if (0 > a && d && !c && !m) r.insertBefore(g, b[m]), l = !0; else if (E(G) <= a || d && (!A(a) || 0 <= a)) r.insertBefore(g, b[m + 1] || null), l = !0
                    }
        ...
        p(f.prototype, {
            Element: O, SVG_NS: U, init: function (a, b, c, r, G, m, d) {
                var v = this.createElement("svg").attr({version: "1.1", "class": "highcharts-root"});
                ...
                l && a.getBoundingClientRect && (b = function () {
                    ...
                    g(a, {left: Math.ceil(q.left) - q.left + "px", top: Math.ceil(q.top) - q.top + "px"})
                }, b(), this.unSubPixelFix = e(W, "resize", b))
            }, definition: function (a) {
                function b(a, e) {
                    var r;
                    h(a).forEach(function (a) {
                        var g = c.createElement(a.tagName), l = {};
                        k(a, function (a, b) {
                ...
                b.init(this, a);
                return b
            }, draw: J, getRadialAttr: function (a, b) {
                return {cx: a[0] - a[2] / 2 + b.cx * a[2], cy: a[1] - a[2] / 2 + b.cy * a[2], r: b.r * a[2]}
            }, truncate: function (a, b, c, e, r, g, l) {
                var G = this, m = a.rotation, d, v = e ? 1 : 0, q = (c || e).length, h = q, B = [], K = function (a) {
                    b.firstChild && b.removeChild(b.firstChild);
                    a && b.appendChild(C.createTextNode(a))
                }, z = function (g, m) {
                    m = m || g;
                    if ("undefined" === typeof B[m]) if (b.getSubStringLength) try {
                        B[m] =
                ...
                var b = a.element, c = this, e = c.forExport,
                    r = n(a.textStr, "").toString(), l = -1 !== r.indexOf("<"), G = b.childNodes, m, d = F(b, "x"),
                    v = a.styles, q = a.textWidth, h = v && v.lineHeight, B = v && v.textOutline,
                    z = v && "ellipsis" === v.textOverflow, f = v && "nowrap" === v.whiteSpace, I = v && v.fontSize, J,
                    P = G.length;
                ...
                if (x !== a.textCache) {
                    ...
                    l || B || z || q || -1 !== r.indexOf(" ") && (!f || S.test(r)) ? (v && v.appendChild(b), l ? (r = c.styledMode ? r.replace(/<(b|strong)>/g, '<span class="highcharts-strong">').replace(/<(i|em)>/g,
                        ...
                        h.forEach(function (r) {
                            if ("" !== r || 1 === h.length) {
                                var B = {}, K = C.createElementNS(c.SVG_NS,
                                    "tspan"), k, n;
                                (k = y(r, "class")) && F(K, "class", k);
                                if (k = y(r, "style")) k = k.replace(/(;| |^)color([ :])/, "$1fill$2"), F(K, "style", k);
                                (n = y(r, "href")) && !e && (F(K, "onclick", 'location.href="' + n + '"'), F(K, "class", "highcharts-anchor"), c.styledMode || g(K, {cursor: "pointer"}));
                                ...
                                if (" " !== r) {
                                    ...
                                    F(K, B);
                                    b.appendChild(K);
                                    !G && J && (!N && e && g(K, {display: "block"}), F(K, "dy", t(K)));
                                    if (q) {
                                        ...
                                        }); else if (B) for (; Q.length;) Q.length && !f && 0 < n && (K = C.createElementNS(U, "tspan"), F(K, {
                                            dy: E,
                                            x: d
                ...
                var h = this.label(a, b, c, d, null, null, q, null, "button"), B = 0, K = this.styledMode;
                h.attr(I({padding: 8, r: 2}, g));
                if (!K) {
                    g = I({
                    ...
                    var N = l.style;
                    delete l.style;
                    G = I(g, {fill: "#e6ebf5", style: {color: "#000000", fontWeight: "bold"}}, G);
                    var k = G.style;
                    delete G.style;
                    m = I(g, {style: {color: "#cccccc"}}, m);
                    var C = m.style;
                    delete m.style
                }
                ...
                K || h.attr(g).css(p({cursor: "default"}, z));
                ...
                t(a) ? (e = a, b = e.y, c = e.r, a = e.x) : e = {innerR: e, start: r, end: g};
                ...
                var e = this.alignedObjects, r = e.length;
                this.width = a;
                this.height = b;
                ...
                if (B) {
                    ...
                    ["width", "height"].forEach(function (a) {
                        K[a +
                        "Setter"] = function (a, b) {
                            var c = {}, e = this["img" + b], r = "width" === b ? "translateX" : "translateY";
                            this[b] = a;
                    ...
                    A(c) && K.attr({x: c, y: e});
                    K.isImg = !0;
                    A(K.imgwidth) && A(K.imgheight) ? k() : (K.attr({width: 0, height: 0}), q("img", {
                        onload: function () {
                            var b = a[m.chartIndex];
                            0 ===
                            this.width && (g(this, {position: "absolute", top: "-999em"}), C.body.appendChild(this));
                            S[N] = {width: this.width, height: this.height};
                ...
                circle: function (a, b, c, e) {
                    ...
                    var g = r.start, l = r.r || c, G = r.r || e || c, m = r.end - .001;
                    c = r.innerR;
                    e = n(r.open, .001 > Math.abs(r.end - r.start - 2 * Math.PI));
                    var v = Math.cos(g), d = Math.sin(g), q = Math.cos(m);
                    m = Math.sin(m);
                    ...
                    var g = Math.min(r && r.r || 0, c, e), l = g + 6, G = r && r.anchorX;
                    r = r && r.anchorY;
                ...
                var r = d.uniqueKey() + "-", g = this.createElement("clipPath").attr({id: r}).add(this.defs);
                ...
                e || (a.xSetter = function (a, b, c) {
                    var e = c.getElementsByTagName("tspan"), r = c.getAttribute(b), g;
                ...
                return {x: -a / 3 * Math.sin(b * m), y: e}
            }, label: function (a, b, c, e, g, l, G, m, v) {
                var d = this, q = d.styledMode, h = d.g("button" !== v && "label"),
                    B = h.text = d.text("", 0, 0, G).attr({zIndex: 1}), z, N, k = 0, C = 3, n = 0, K, f, U, J, E,
                    Q = {}, t, y, S = /^url\((.*?)\)$/.test(e), x = q || S, W = function () {
                        return q ? z.strokeWidth() % 2 / 2 : (t ? parseInt(t, 10) : 0) % 2 /
                            2
                    };
                v && h.addClass("highcharts-" + v);
                var H = function () {
                    var a = B.element.style, b = {};
                ...
                var Y = function () {
                    var a = n + C;
                    var b = m ? 0 : y;
                    A(K) && N && ("center" === E || "right" === E) && (a += {center: .5, right: 1}[E] * (K - N.width));
                ...
                h.onAdd = function () {
                    B.add(h);
                    h.attr({text: a || 0 === a ? a : "", x: b, y: c});
                    z && A(g) && h.attr({anchorX: g, anchorY: l})
                };
                ...
                h.alignSetter = function (a) {
                    ...
                    a !== k && (k = a, N && h.attr({x: U}))
                };
                h.textSetter = function (a) {
                    "undefined" !== typeof a && B.attr({text: a});
                    H();
                    Y()
                };
                ...
                G = {
                    css: function (a) {
                        ...
                        return {width: N.width + 2 * C, height: N.height + 2 * C, x: N.x - C, y: N.y - C}
                    }, destroy: function () {
    ...
    M(w, "parts/Html.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var L = f.attr, F = f.defined, A = f.extend, D = f.pick, x = f.pInt, p = d.createElement,
            H = d.css, u = d.isFirefox, t = d.isMS, y = d.isWebKit, k = d.SVGElement;
        f = d.SVGRenderer;
        var n = d.win;
        A(k.prototype, {
            htmlCss: function (d) {
                var h = "SPAN" === this.element.tagName && d && "width" in d, e = D(h && d.width, void 0);
                if (h) {
                    delete d.width;
                    this.textWidth = e;
                    var c = !0
                ...
                if (this.added) {
                    var d = this.renderer, h = this.element, e = this.translateX || 0, c = this.translateY || 0,
                        a = this.x || 0, b = this.y || 0, g = this.textAlign || "left",
                        q = {left: 0, center: .5, right: 1}[g], m = this.styles, k = m && m.whiteSpace;
                    H(h, {marginLeft: e, marginTop: c});
                    !d.styledMode && this.shadows && this.shadows.forEach(function (a) {
                        H(a, {marginLeft: e + 1, marginTop: c + 1})
                    });
                    ...
                    if ("SPAN" === h.tagName) {
                        ...
                        var z = this.textWidth && x(this.textWidth),
                            l = [m, g, h.innerHTML, this.textWidth, this.textAlign].join(), v;
                        ...
                        H(h, {left: a + (this.xCorr || 0) + "px", top: b + (this.yCorr || 0) + "px"});
                        this.cTT = l;
                        this.oldRotation = m;
                        this.oldAlign = g
                    }
                ...
                var c = {}, a = this.renderer.getTransformKey();
        ...
        A(f.prototype, {
            getTransformKey: function () {
                ...
                var c = this.createElement("span"), a = c.element, b = c.renderer, g = b.isSVG, q = function (a, b) {
                ...
                c.attr({text: d, x: Math.round(h), y: Math.round(e)}).css({position: "absolute"});
                b.styledMode || c.css({fontFamily: this.style.fontFamily, fontSize: this.style.fontSize});
                a.style.whiteSpace = "nowrap";
                c.css = c.htmlCss;
                g && (c.add = function (e) {
                    var g = b.box.parentNode, m = [];
                    if (this.parentGroup = e) {
                        ...
                        if (!l) {
                            ...
                            m.reverse().forEach(function (a) {
                                ...
                                l = a.div = a.div || p("div", e ? {className: e} : void 0, {
                                        position: "absolute",
                                ...
                                A(a, {
                                    classSetter: function (a) {
                                        ...
                                        m[0].div && c.on.apply({element: m[0].div}, arguments);
                                        return a
    ...
    M(w, "parts/Time.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var L = f.defined, F = f.extend, A = f.isObject, D = f.objectEach, x =
            f.pad, p = f.pick, H = f.splat, u = d.merge, t = d.timeUnits, y = d.win;
        d.Time = function (d) {
            this.update(d, !1)
        };
        d.Time.prototype = {
            ...
            update: function (d) {
                ...
                this.timezoneOffset ? (this.get = function (d, e) {
                    var c = e.getTime(), a = c - f.getTimezoneOffset(e);
                    e.setTime(a);
                    d = e["getUTC" + d]();
                    e.setTime(c);
                    return d
                }, this.set = function (d, e, c) {
                    if ("Milliseconds" === d || "Seconds" === d || "Minutes" === d && 0 === e.getTimezoneOffset() % 60) e["set" + d](c); else {
            ...
            timezoneOffsetFunction: function () {
                var k = this, n = this.options, f = y.moment;
            ...
            dateFormat: function (k, n, f) {
                ...
                k = p(k, "%Y-%m-%d %H:%M:%S");
                var h = this, e = new this.Date(n), c = this.get("Hours", e), a = this.get("Day", e),
                    b = this.get("Date", e), g = this.get("Month", e), q = this.get("FullYear",
                    e), m = d.defaultOptions.lang, C = m.weekdays, z = m.shortWeekdays;
                e = F({
            ...
            resolveDTLFormat: function (d) {
                return A(d, !0) ? d : (d = H(d), {main: d[0], from: d[1], to: d[2]})
            },
            getTimeTicks: function (d, n, f, h) {
                var e = this, c = [], a = {};
                var b = new e.Date(n);
                var g = d.unitRange, q = d.count || 1, m;
                h = p(h, 1);
                if (L(n)) {
                    ...
                    k = e.get("FullYear", b);
                    h = e.get("Month", b);
                    var z = e.get("Date", b), l = e.get("Hours", b);
                    n = b.getTime();
                ...
                c.info = F(d, {higherRanks: a, totalRange: g * q});
                return c
            }
        }
    });
    M(w, "parts/Options.js", [w["parts/Globals.js"]], function (d) {
        var f = d.color, L = d.merge;
        d.defaultOptions = {
    ...
    M(w, "parts/Tick.js",
        [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
            var L = f.clamp, F = f.correctFloat, A = f.defined, D = f.destroyObjectProperties, x = f.extend,
                p = f.isNumber, H = f.objectEach, u = f.pick, t = d.fireEvent, y = d.merge, k = d.deg2rad;
            ...
            d.Tick.prototype = {
                addLabel: function () {
                    var d = this, k = d.axis,
                        h = k.options, e = k.chart, c = k.categories, a = k.names, b = d.pos,
                        g = u(d.options && d.options.labels, h.labels), q = k.tickPositions, m = b === q[0],
                        f = b === q[q.length - 1];
                    ...
                    d.isLast = f;
                    d.formatCtx = {
                        axis: k, chart: e, isFirst: m, isLast: f, dateTimeLabelFormat: I, tickPositionInfo: q,
                        value: k.isLog ? F(k.lin2log(a)) : a, pos: b
                    };
                    h = k.labelFormatter.call(d.formatCtx, this.formatCtx);
                    if (v = B && B.list) d.shortenLabel = function () {
                        for (l = 0; l < v.length; l++) if (z.attr({text: k.labelFormatter.call(x(d.formatCtx, {dateTimeLabelFormat: v[l]}))}), z.getBBox().width < k.getSlotWidth(d) - 2 * u(g.padding, 5)) return;
                        z.attr({text: ""})
                    };
                    c && k._addedPlotLB && k.isXAxis && d.moveLabel(h, g);
                    A(z) || d.movedLabel ? z && z.textStr !== h && !c && (!z.textWidth || g.style && g.style.width || z.styles.width || z.css({width: null}), z.attr({text: h}), z.textPxLength =
                        z.getBBox().width) : (d.label = z = d.createLabel({x: 0, y: 0}, h, g), d.rotation = 0)
                }, moveLabel: function (d, k) {
                    var h = this, e = h.label, c = !1, a = h.axis, b = a.reversed, g = a.chart.inverted;
                    ...
                    if (!c && (h.labelPos || e)) {
                        ...
                        h.movedLabel = h.createLabel({x: e, y: a},
                            d, k);
                    ...
                    var d = this.label, k = this.axis, h = k.reversed, e = this.axis.chart.inverted;
                    if (d && !this.isNew) {
                        var c = e ? d.xy.x : h ? k.left : k.width + k.left;
                        h = e ? h ? k.width + k.top : k.top : d.xy.y;
                        d.animate({x: c, y: h, opacity: 0}, void 0, d.destroy);
                        delete this.label
                    }
                    k.isDirty =
                        !0;
                    ...
                    var f = this.axis, h = f.options.labels, e = d.x, c = f.chart.chartWidth, a = f.chart.spacing,
                        b = u(f.labelLeft, Math.min(f.pos, a[3]));
                    a = u(f.labelRight, Math.max(f.isRadial ? 0 : f.pos + f.len, c - a[1]));
                    var g = this.label, q = this.rotation,
                        m = {left: 0, center: .5, right: 1}[f.labelAlign || g.attr("align")], C = g.getBBox().width,
                        z = f.getSlotWidth(this), l = z, v =
                            1, B, I = {};
                    if (q || "justify" !== u(h.overflow, "justify")) 0 > q && e - m * C < b ? B = Math.round(e / Math.cos(q * k) - b) : 0 < q && e + m * C > a && (B = Math.round((c - e) / Math.cos(q * k))); else if (c = e + (1 - m) * C, e - m * C < b ? l = d.x + l * (1 - m) - b : c > a && (l = a - d.x + l * m, v = -1), l = Math.min(z, l), l < z && "center" === f.labelAlign && (d.x += v * (z - l - m * (z - Math.min(C, l)))), C > l || f.autoRotation && (g.styles || {}).width) B = l;
                    B && (this.shortenLabel ? this.shortenLabel() : (I.width = Math.floor(B), (h.style || {}).textOverflow || (I.textOverflow = "ellipsis"), g.css(I)))
                                          ...
                                          e) {
                    var c = this.axis, a = c.chart, b = e && a.oldChartHeight || a.chartHeight;
                    d = {
                    ...
                    var q = this.axis, m = q.transA,
                        C = q.isLinked && q.linkedParent ? q.linkedParent.reversed : q.reversed, z = q.staggerLines,
                        l = q.tickRotCorr || {x: 0, y: 0}, v = c.y,
                    ...
                    I.x = d;
                    I.y = Math.round(f);
                    t(this, "afterGetLabelPosition", {pos: I, tickmarkOffset: a, index: b});
                    return I
                }, getMarkPath: function (d, k, h, e, c, a) {
                    return a.crispLine(["M",
                        d, k, "L", d + (c ? 0 : -h), k + (c ? h : 0)], e)
                }, renderGridLine: function (d, k, h) {
                    var e = this.axis, c = e.options, a = this.gridLine, b = {}, g = this.pos, q = this.type,
                        m = u(this.tickmarkOffset, e.tickmarkOffset), f = e.chart.renderer, z = q ? q + "Grid" : "grid",
                        l = c[z + "LineWidth"], v = c[z + "LineColor"];
                    c = c[z + "LineDashStyle"];
                    ...
                    if (a && (h = e.getPlotLinePath({
                        value: g +
                            m, lineWidth: a.strokeWidth() * h, force: "pass", old: d
                    }))) a[d || this.isNew ? "attr" : "animate"]({d: h, opacity: k})
                }, renderMark: function (d, k, h) {
                    var e = this.axis, c = e.options, a = e.chart.renderer, b = this.type, g = b ? b + "Tick" : "tick",
                        q = e.tickSize(g), m = this.mark, f = !m, z = d.x;
                    d = d.y;
                    ...
                    q && (e.opposite && (q[0] = -q[0]), f && (this.mark = m = a.path().addClass("highcharts-" + (b ? b + "-" : "") + "tick").add(e.axisGroup), e.chart.styledMode || m.attr({
                        ...
                        d: this.getMarkPath(z,
                            d, q[0], m.strokeWidth() * h, e.horiz, a), opacity: k
                    }))
                }, renderLabel: function (d, k, h, e) {
                    var c = this.axis, a = c.horiz, b = c.options, g = this.label, q = b.labels, m = q.step;
                    ...
                    var e = this.axis, c = e.horiz, a = this.pos, b = u(this.tickmarkOffset, e.tickmarkOffset);
    ...
    M(w, "parts/Axis.js", [w["parts/Globals.js"], w["parts/Utilities.js"]],
        function (d, f) {
            var L = f.animObject, F = f.arrayMax, A = f.arrayMin, D = f.clamp, x = f.correctFloat, p = f.defined,
                H = f.destroyObjectProperties, u = f.extend, t = f.isArray, y = f.isNumber, k = f.isString,
                n = f.objectEach, E = f.pick, h = f.relativeLength, e = f.splat, c = f.syncTimeout, a = d.addEvent,
                b = d.color, g = d.defaultOptions, q = d.deg2rad, m = d.fireEvent, C = d.format, z = d.getMagnitude,
                l = d.merge, v = d.normalizeTickInterval, B = d.removeEvent, I = d.seriesTypes, J = d.Tick;
            f = function () {
                this.init.apply(this, arguments)
            };
            u(f.prototype, {
                ...
                init: function (b, c) {
                    ...
                    c = g.options.events;
                    -1 === b.axes.indexOf(g) && (r ? b.axes.splice(b.xAxis.length,
                ...
                defaultLabelFormatter: function () {
                    var a = this.axis, b = this.value, c = a.chart.time, e = a.categories, l = this.dateTimeLabelFormat,
                        d = g.lang, m = d.numericSymbols;
                    d = d.numericSymbolMagnitude || 1E3;
                    var q = m && m.length, v = a.options.labels.format;
                    a = a.isLog ? Math.abs(b) : a.tickInterval;
                    var h = this.chart, B = h.numberFormatter;
                    if (v) var k = C(v, this, h); else if (e) k = b; else if (l) k = c.dateFormat(l, b); else if (q && 1E3 <= a) for (; q-- && "undefined" === typeof k;) c = Math.pow(d, q + 1), a >= c &&
                ...
                translate: function (a, b, c, e, g, l) {
                    var r = this.linkedParent || this, d = 1, G = 0, m = e ? r.oldTransA : r.transA;
                    e = e ? r.oldMin : r.min;
                ...
                getPlotLinePath: function (a) {
                    var b = this, c = b.chart, e = b.left, g = b.top, r = a.old, l = a.value, d = a.translatedValue,
                        q = a.lineWidth, v = a.force, h, B, k, z, f = r && c.oldChartHeight || c.chartHeight,
                        C = r && c.oldChartWidth || c.chartWidth, I, J = b.transB, n = function (a, b, c) {
                            if ("pass" !== v && a < b || a > c) v ? a = D(a, b, c) : I = !0;
                            return a
                        };
                    a = {value: l, lineWidth: q, old: r, force: v, acrossPanes: a.acrossPanes, translatedValue: d};
                ...
                getMinorTickPositions: function () {
                    var a = this, b = a.options, c = a.tickPositions, e = a.minorTickInterval, g = [],
                        l = a.pointRangePadding || 0, d = a.min - l;
                    l = a.max + l;
                    var m = l - d;
                    if (m && m / e < a.len / 3) if (a.isLog) this.paddedTicks.forEach(function (b, c, r) {
                    ...
                    else for (b = d + (c[0] - d) % e; b <= l && b !== g[0]; b += e) g.push(b);
                    0 !== g.length && a.trimTicks(g);
                    return g
                },
                adjustForMinRange: function () {
                    var a = this.options, b = this.min, c = this.max, e, g, l, d, m;
                    this.isXAxis && "undefined" === typeof this.minRange && !this.isLog && (p(a.min) || p(a.max) ? this.minRange = null : (this.series.forEach(function (a) {
                        d = a.xData;
                        for (g = m = a.xIncrement ? 1 : d.length - 1; 0 < g; g--) if (l = d[g] - d[g - 1], "undefined" === typeof e || l < e) e = l
                ...
                getClosest: function () {
                    ...
                    this.categories ? a = 1 : this.series.forEach(function (b) {
                        var c = b.closestPointRange, e = b.visible || !b.chart.options.chart.ignoreHiddenSeries;
                ...
                nameToX: function (a) {
                    var b = t(this.categories), c = b ? this.categories : this.names, e = a.options.x;
                ...
                setAxisTranslation: function (a) {
                    var b = this, c = b.max - b.min, e = b.axisPointRange || 0, g = 0, l = 0, d = b.linkedParent,
                        r = !!b.categories, q = b.transA, v = b.isXAxis;
                    if (v || r || e) {
                        var h =
                            b.getClosest();
                ...
                setTickInterval: function (a) {
                    var b = this, c = b.chart, e = b.options, g = b.isLog, l = b.isDatetimeAxis, r = b.isXAxis,
                        q = b.isLinked, h = e.maxPadding, B = e.minPadding, k = e.tickInterval, f = e.tickPixelInterval,
                        C = b.categories, I = y(b.threshold) ? b.threshold : null, J = b.softThreshold;
                    ...
                    if (q) {
                        ...
                        if (!J && p(I)) if (b.dataMin >= I) u = I, B = 0; else if (b.dataMax <= I) {
                            var H = I;
                            h = 0
                        }
                ...
                setTickPositions: function () {
                    ...
                    var e = a.tickPositioner, g = a.startOnTick, l = a.endOnTick;
                ...
                trimTicks: function (a, b, c) {
                    var e = a[0], g = a[a.length - 1], l = this.minPointOffset || 0;
                    m(this, "trimTicks");
                    if (!this.isLinked) {
                        if (b && -Infinity !==
                            e) this.min = e; else for (; this.min - l > a[0];) a.shift();
                        if (c) this.max = g; else for (; this.max + l < a[a.length - 1];) a.pop();
                ...
                adjustTickAmount: function () {
                    var a = this.options, b = this.tickInterval, c = this.tickPositions, e = this.tickAmount,
                        g = this.finalTickAmt, l = c && c.length, d = E(this.threshold, this.softThreshold ? 0 : null),
                        m;
                    if (this.hasData()) {
                        if (l < e) {
                            for (m =
                ...
                zoom: function (a, b) {
                    var c = this.dataMin, e = this.dataMax, g = this.options, l = Math.min(c, E(g.min, c)),
                        d = Math.max(e, E(g.max, e));
                    a = {newMin: a, newMax: b};
                    m(this, "zoom", a, function (a) {
                        var b = a.newMin, g = a.newMax;
                        if (b !== this.min || g !== this.max) this.allowZoomOutside ||
                        (p(c) && (b < l && (b = l), b > d && (b = d)), p(e) && (g < l && (g = l), g > d && (g = d))), this.displayBtn = "undefined" !== typeof b || "undefined" !== typeof g, this.setExtremes(b, g, !1, void 0, {trigger: "zoom"});
                        a.zoomed = !0
                    });
                    return a.zoomed
                },
                ...
                unsquish: function () {
                    var a = this.options.labels, b = this.horiz, c = this.tickInterval, e = c,
                        g = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / c), l, d = a.rotation,
                        m = this.labelMetrics(), v, h = Number.MAX_VALUE, B, k = this.max - this.min, z = function (a) {
                            var b = a / (g || 1);
                            b =
                                1 < b ? Math.ceil(b) : 1;
                ...
                getSlotWidth: function (a) {
                    var b = this.chart, c = this.horiz, e = this.options.labels,
                ...
                renderUnsquish: function () {
                    var a = this.chart, b = a.renderer, c = this.tickPositions, e = this.ticks, g = this.options.labels,
                        l = g && g.style || {}, d = this.horiz, m = this.getSlotWidth(),
                        q = Math.max(1, Math.round(m - 2 * (g.padding || 5))), v = {}, h = this.labelMetrics(),
                        B = g.style && g.style.textOverflow, z = 0;
                    ...
                    if (this.autoRotation) z > q && z > h.h ? v.rotation = this.labelRotation : this.labelRotation = 0; else if (m) {
                        var f = q;
                        if (!B) {
                            var C = "clip";
                            for (q = c.length; !d && q--;) {
                                var I = c[q];
                                if (I = e[I].label) I.styles && "ellipsis" === I.styles.textOverflow ? I.css({textOverflow: "clip"}) : I.textPxLength > m && I.css({width: m + "px"}), I.getBBox().height > this.len / c.length - (h.h - h.f) && (I.specificTextOverflow =
                                    "ellipsis")
                            }
                        }
                    }
                    ...
                    c.forEach(function (a) {
                        var b = (a = e[a]) && a.label, c = l.width, g = {};
                        b && (b.attr(v), a.shortenLabel ? a.shortenLabel() : f && !c && "nowrap" !== l.whiteSpace && (f < b.textPxLength || "SPAN" === b.element.tagName) ? (g.width = f, B || (g.textOverflow = b.specificTextOverflow || C), b.css(g)) : b.styles && b.styles.width && !g.width && !c && b.css({width: null}), delete b.specificTextOverflow,
                ...
                addTitle: function (a) {
                    var b = this.chart.renderer, c = this.horiz, e = this.opposite, g = this.options.title, d,
                        r = this.chart.styledMode;
                    this.axisTitle || ((d = g.textAlign) || (d = (c ? {
                        low: "left",
                        middle: "center",
                        high: "right"
                    } : {low: e ? "right" : "left", middle: "center", high: e ? "left" : "right"})[g.align]),
                    ...
                    r || g.style.width || this.isRadial || this.axisTitle.css({width: this.len});
                ...
                getOffset: function () {
                    var a = this, b = a.chart, c = b.renderer, e = a.options, g = a.tickPositions, l = a.ticks,
                        d = a.horiz, v = a.side, q = b.inverted && !a.isZAxis ? [1, 0, 3, 2][v] : v, h, B = 0, k = 0,
                        z = e.title, f = e.labels, C = 0, I = b.axisOffset;
                    b = b.clipOffset;
                    var J = [-1, 1, 1, -1][v], t = e.className, y = a.axisParent;
                    var x = a.hasData();
                    a.showAxis = h = x || E(e.showEmpty, !0);
                    a.staggerLines = a.horiz && f.staggerLines;
                    a.axisGroup || (a.gridGroup = c.g("grid").attr({zIndex: e.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (t || "")).add(y), a.axisGroup = c.g("axis").attr({zIndex: e.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() +
                        " " + (t || "")).add(y), a.labelGroup = c.g("axis-labels").attr({zIndex: f.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (t || "")).add(y));
                ...
                getLinePath: function (a) {
                    ...
                    return b.renderer.crispLine(["M", g ? this.left : l, g ? e : this.top, "L", g ? b.chartWidth - this.right :
                        l, g ? e : b.chartHeight - this.bottom], a)
                },
                renderLine: function () {
                ...
                getTitlePosition: function () {
                    var a = this.horiz, b = this.left, c = this.top, e = this.len, g = this.options.title,
                        l = a ? b : c, d = this.opposite, v = this.offset, q = g.x || 0, h = g.y || 0,
                        B = this.axisTitle, k = this.chart.renderer.fontMetrics(g.style &&
                        g.style.fontSize, B);
                    B = Math.max(B.getBBox(null, 0).height - k.h - 1, 0);
                    e = {low: l + (a ? 0 : e), middle: l + e / 2, high: l + (a ? e : 0)}[g.align];
                ...
                renderMinorTick: function (a) {
                    var b = this.chart.hasRendered && y(this.oldMin), c = this.minorTicks;
                ...
                renderTick: function (a, b) {
                    var c = this.isLinked, e = this.ticks, g = this.chart.hasRendered && y(this.oldMin);
                    if (!c || a >= this.min && a <= this.max) e[a] || (e[a] = new J(this, a)), g && e[a].isNew && e[a].render(b, !0, -1), e[a].render(b)
                },
                render: function () {
                    var a = this, b = a.chart, e = a.options, g = a.isLog, l = a.isLinked, v = a.tickPositions,
                        q = a.axisTitle, h = a.ticks, B = a.minorTicks, k = a.alternateBands, z = e.stackLabels,
                        f = e.alternateGridColor, C = a.tickmarkOffset, I = a.axisLine, t = a.showAxis,
                        p = L(b.renderer.globalAnimation), E, x;
                    a.labelEdge.length =
                        0;
                    a.overlap = !1;
                    ...
                    I && (I[I.isPlaced ? "animate" : "attr"]({d: this.getLinePath(I.strokeWidth())}),
                ...
                destroy: function (a) {
                    var b = this, c = b.stacks, e = b.plotLinesAndBands,
                        g;
                ...
                drawCrosshair: function (a,
                                         c) {
                    var e = this.crosshair, g = E(e.snap, !0), l, d = this.cross;
                    ...
                    if (this.crosshair && !1 !== (p(c) || !g)) {
                        ...
                        if (p(l)) {
                            var v = {value: c && (this.isXAxis ? c.x : E(c.stackY, c.y)), translatedValue: l};
                        ...
                        d || (this.cross = d = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (g ? "category " : "thin ") + e.className).attr({zIndex: E(e.zIndex, 2)}).add(), this.chart.styledMode || (d.attr({
                        ...
                        d.show().attr({d: v});
                        g && !e.width && d.attr({"stroke-width": this.transA});
                        this.cross.e = a
    ...
    M(w, "parts/DateTimeAxis.js", [w["parts/Globals.js"]], function (d) {
        var f = d.Axis, L = d.getMagnitude, F = d.normalizeTickInterval, A = d.timeUnits;
        ...
        f.prototype.normalizeTimeTickInterval = function (d, f) {
            ...
            return {unitRange: x, count: d, unitName: f[0]}
        }
    });
    M(w, "parts/LogarithmicAxis.js", [w["parts/Globals.js"], w["parts/Utilities.js"]],
        function (d, f) {
            var L = f.pick;
            f = d.Axis;
            var F = d.getMagnitude, A = d.normalizeTickInterval;
            f.prototype.getLogTickPositions = function (d, f, p, H) {
                var x = this.options, t = this.len, y = [];
                H || (this._minorAutoInterval = null);
                if (.5 <= d) d = Math.round(d), y = this.getLinearTickPositions(d, f, p); else if (.08 <= d) {
                    t = Math.floor(f);
                    var k, n;
    ...
    M(w, "parts/PlotLineOrBand.js",
        [w["parts/Globals.js"], w["parts/Axis.js"], w["parts/Utilities.js"]], function (d, f, L) {
            var F = L.arrayMax, A = L.arrayMin, D = L.defined, x = L.destroyObjectProperties, p = L.erase, H = L.extend,
                u = L.objectEach, t = L.pick, y = d.merge;
            ...
            d.PlotLineOrBand.prototype = {
                render: function () {
                    ...
                    var k = this, f = k.axis, p = f.horiz, h = k.options, e = h.label, c = k.label, a = h.to,
                        b = h.from, g = h.value, q = D(b) && D(a), m = D(g), C = k.svgElem, z = !C, l = [], v = h.color,
                        B = t(h.zIndex,
                            0), I = h.events;
                    l = {"class": "highcharts-plot-" + (q ? "band " : "line ") + (h.className || "")};
                    var J = {}, r = f.chart.renderer, G = q ? "bands" : "lines";
                    ...
                    }); else if (q) l = f.getPlotBandPath(b, a, h); else return;
                    (z || !C.d) && l && l.length ? (C.attr({d: l}), I && u(I, function (a, b) {
                        C.on(b, function (a) {
                            I[b].apply(k, [a])
                        })
                    })) : C && (l ? (C.show(!0), C.animate({d: l})) : C.d && (C.hide(), c && (k.label = c = c.destroy())));
                    e && (D(e.text) || D(e.formatter)) && l && l.length && 0 < f.width && 0 < f.height && !l.isFlat ? (e = y({
                        align: p && q && "center", x: p ? !q && 4 : 10, verticalAlign: !p && q && "middle",
                        y: p ? q ? 16 : 10 : q ? 6 : -4, rotation: p && !q && 90
                    ...
                    t = A(c);
                    h = A(f);
                    e.align(d, !1, {x: t, y: h, width: F(c) - t, height: F(f) - h});
                    e.show(!0)
            ...
            H(f.prototype, {
                getPlotBandPath: function (d, f) {
                    var k = this.getPlotLinePath({value: f, force: !0, acrossPanes: this.options.acrossPanes}),
                        h = this.getPlotLinePath({value: d, force: !0, acrossPanes: this.options.acrossPanes}), e = [],
                        c = this.horiz, a = 1;
                    ...
                    var k = (new d.PlotLineOrBand(this, f)).render(), h = this.userOptions;
                    if (k) {
                        if (t) {
                            var e = h[t] || [];
                            e.push(f);
    ...
    M(w, "parts/Tooltip.js",
        [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
            var L = f.clamp, F = f.defined, A = f.discardElement, D = f.extend, x = f.isNumber, p = f.isString,
                H = f.pick, u = f.splat, t = f.syncTimeout;
            "";
            var y = d.doc, k = d.format, n = d.merge, E = d.timeUnits;
            d.Tooltip = function () {
                this.init.apply(this, arguments)
            };
            d.Tooltip.prototype = {
                init: function (d, e) {
                    ...
                    var h = this, e = this.chart.renderer, c = this.chart.styledMode, a = this.options,
                        b = "tooltip" + (F(a.className) ? " " + a.className : ""), g;
                    if (!this.label) {
                    ...
                    var c = this.chart, a = c.pointer, b = c.inverted, g = c.plotTop, q = c.plotLeft, m = 0, h = 0, f,
                        l;
                    d = u(d);
                    ...
                    var a = this.chart, b = this.distance, g = {}, q = a.inverted && c.h || 0, m, h = this.outside,
                        ...
                        v = a.pointer.getChartPosition(), B = a.containerScaling, k = function (a) {
                        ...
                        H(c.ttBelow, !a.inverted === !!c.negative), p = function (a, c, e, d, l, m, v) {
                            var h = "y" === a ? J(b) : k(b), r = (e - d) / 2, B = d < l - b, f = l + b + d < c,
                                z = l - h - e + r;
                            l = l + h - r;
                            if (n && f) g[a] = l; else if (!n && B) g[a] = z; else if (B) g[a] = Math.min(v - d, 0 > z - q ? z : z - q); else if (f) g[a] = Math.max(m, l + q + e > c ? l : l + q); else return !1
                    ...
                    var c = this.chart, a = this.options, b = h, g = {}, q = [],
                    ...
                    if (a.enabled) {
                        ...
                        }), g = {x: b[0].category, y: b[0].y}, g.points = q, b = b[0]);
                        this.len = q.length;
                        c = m.call(g, this);
                        m = b.series;
                        this.distance = H(m.tooltipOptions.distance, 16);
                        !1 === c ? this.hide() : (this.split ? this.renderSplit(c, u(h)) : (h = this.getLabel(), a.style.width && !f || h.css({width: this.chart.spacingBox.width}), h.attr({text: c && c.join ? c.join("") : c}), h.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" +
                            H(b.colorIndex, m.colorIndex)), f || h.attr({stroke: a.borderColor || b.color || m.color || "#666666"}), this.updatePosition({
                            plotX: e,
                            plotY: l,
                            negative: b.negative,
                            ttBelow: b.ttBelow,
                    ...
                    var a = this, b = a.chart, g = a.chart, q = g.chartWidth,
                        m = g.chartHeight, f = g.plotHeight, k = g.plotLeft, l = g.plotTop, v = g.plotWidth,
                        B = g.pointer, I = g.renderer, J = g.scrollablePixelsX;
                    J = void 0 === J ? 0 : J;
                    var r = g.scrollablePixelsY, G = void 0 === r ? 0 : r;
                    r = g.scrollingContainer;
                    r = void 0 === r ? {scrollLeft: 0, scrollTop: 0} : r;
                    var t = r.scrollLeft, n = r.scrollTop, y = g.styledMode, x = a.distance, u = a.options,
                        E = a.options.positioner,
                        K = {left: J ? k : 0, right: J ? k + v - J : q, top: G ? l : 0, bottom: G ? l + f - G : m},
                        Q = a.getLabel(), A = !(!b.xAxis[0] || !b.xAxis[0].opposite), F = l, w = 0, X = f - G;
                    p(h) && (h = [!1, h]);
                    h = h.slice(0, e.length +
                        1).reduce(function (b, g, d) {
                        if (!1 !== g && "" !== g) {
                            d = e[d - 1] || {isHeader: !0, plotX: e[0].plotX, plotY: f, series: {}};
                            var m = d.isHeader, v = m ? a : d.series, q = v.tt, h = d.isHeader;
                            var r = d.series;
                            ...
                            q.isActive = !0;
                            q.attr({text: g});
                            y || q.css(u.style).shadow(u.shadow).attr({stroke: u.borderColor || d.color || r.color || "#333333"});
                            g = v.tt = q;
                            h = g.getBBox();
                    ...
                    var e = this.chart, c = e.pointer, a = this.getLabel(), b = h.plotX + e.plotLeft,
                        g = h.plotY + e.plotTop;
                    ...
                    var b = this.chart.time, g = b.dateFormat("%m-%d %H:%M:%S.%L", e),
                        q = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3}, m = "millisecond";
                    for (h in E) {
                    ...
                    var c = e ? "footer" : "header", a = h.series, b = a.tooltipOptions, g = b.xDateFormat, q = a.xAxis,
                        m = q && "datetime" === q.options.type && x(h.key), f = b[c + "Format"];
                    e = {isFooter: e, labelConfig: h};
                    d.fireEvent(this, "headerFormatter", e, function (c) {
                        m && !g && (g = this.getXDateFormat(h, b, q));
                        m && g && (h.point && h.point.tooltipDateKeys ||
                            ["key"]).forEach(function (a) {
                            f = f.replace("{point." + a + "}", "{point." + a + ":" + g + "}")
                        });
                        a.chart.styledMode && (f = this.styledModeFormat(f));
                        c.text = k(f, {point: h, series: a}, this.chart)
                    });
                    return e.text
    ...
    M(w, "parts/Pointer.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var L = f.attr, F = f.defined, A = f.extend, D = f.isNumber, x = f.isObject, p = f.objectEach, H = f.offset,
            u = f.pick, t = f.splat, y = d.addEvent, k = d.charts, n = d.color, E = d.css, h = d.find, e = d.fireEvent,
            c = d.Tooltip;
        ...
        d.Pointer.prototype = {
            init: function (a, b) {
                ...
                var b = this.chart, c = b.options.chart, e = c.zoomType || "";
                b = b.inverted;
                ...
                return A(a, {chartX: Math.round(e), chartY: Math.round(b)})
                ...
                return b
                                                       ...
                                                       b) {
                var c = a.series, e = c.xAxis;
                c = c.yAxis;
                var d = u(a.clientX, a.plotX), h = a.shapeArgs;
                if (e && c) return b ? {
                    chartX: e.len + e.pos - d,
                    chartY: c.len + c.pos - a.plotY
                } : {chartX: d + e.pos, chartY: a.plotY + c.pos};
                ...
                return {hoverPoint: g, hoverSeries: b, hoverPoints: l}
            }, runPointActions: function (a, b) {
                var c = this.chart, e = c.tooltip && c.tooltip.options.enabled ? c.tooltip : void 0,
                    m = e ? e.shared : !1, h = b || c.hoverPoint, f = h && h.series || c.hoverSeries;
                ...
                c.axes.forEach(function (b) {
                    var c = u(b.crosshair.snap, !0), e = c ? d.find(l, function (a) {
            ...
            applyInactiveState: function (a) {
                ...
                var c = this.chart, e = c.hoverSeries, d = c.hoverPoint, h = c.hoverPoints, f = c.tooltip,
                    l = f && f.shared ? h : d;
                ...
                var b = this.chart, c = b.options.chart, e = a.chartX, d = a.chartY, h = this.zoomHor,
                    f = this.zoomVert, l = b.plotLeft, v = b.plotTop, B = b.plotWidth, k = b.plotHeight,
                    J = this.selectionMarker, r = this.mouseDownX, G = this.mouseDownY,
                    t = x(c.panning) ? c.panning && c.panning.enabled : c.panning, p = c.panKey && a[c.panKey + "Key"];
                if (!J || !J.touch) if (e < l ? e = l : e > l + B && (e = l + B), d < v ? d = v : d > v + k && (d = v + k), this.hasDragged = Math.sqrt(Math.pow(r -
                    ...
                    b.hasCartesianSeries && (this.zoomX || this.zoomY) && y && !p && !J && (this.selectionMarker = J = b.renderer.rect(l, v, h ? 1 : B, f ? 1 : k, 0).attr({
                        ...
                        zIndex: 7
                    }).add(), b.styledMode || J.attr({fill: c.selectionMarkerFill || n("#335cad").setOpacity(.25).get()}));
                    J && h && (e -= r, J.attr({width: Math.abs(e), x: (0 < e ? 0 : e) + r}));
                    J && f && (e = d - G, J.attr({height: Math.abs(e), y: (0 < e ? 0 : e) + G}));
                ...
                if (this.selectionMarker) {
                    var m = {originalEvent: a, xAxis: [], yAxis: []}, h = this.selectionMarker,
                        f = h.attr ? h.attr("x") : h.x, l = h.attr ? h.attr("y") : h.y,
                        v = h.attr ? h.attr("width") : h.width, B = h.attr ? h.attr("height") : h.height, k;
                ...
                var b = this.chart, c = b.hoverPoint, d = b.plotLeft, m = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (e(c.series, "click", A(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (A(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY -
                    m) && e(b, "click", a)))
            }, setDOMEvents: function () {
                var a = this, b = a.chart.container, c = b.ownerDocument;
    ...
    M(w, "parts/TouchPointer.js", [w["parts/Globals.js"], w["parts/Utilities.js"]],
        function (d, f) {
            var L = f.extend, F = f.pick, A = d.charts, D = d.noop;
            L(d.Pointer.prototype, {
                pinchTranslate: function (d, f, A, u, t, y) {
                    ...
                    var p = this.chart, h = d ? "x" : "y", e = d ? "X" : "Y", c = "chart" + e,
                        a = d ? "width" : "height", b = p["plot" + (d ? "Left" : "Top")], g, q, m = n || 1,
                        C = p.inverted, z = p.bounds[d ? "h" : "v"], l = 1 === f.length, v = f[0][c], B = A[0][c],
                        I = !l && f[1][c], J = !l && A[1][c];
                    A =
                        function () {
                    ...
                    var f = this, x = f.chart, u = f.pinchDown, t = d.touches, y = t.length, k = f.lastValidTouch,
                        n = f.hasZoom, E = f.selectionMarker, h = {}, e = 1 === y && (f.inClass(d.target,
                        "highcharts-tracker") && x.runTrackerClick || f.runChartClick), c = {};
                    1 < y && (f.initiated = !0);
                    ...
                    "touchstart" === d.type ? ([].forEach.call(t, function (a, b) {
                        ...
                        if (a.zoomEnabled) {
                            var b = x.bounds[a.horiz ? "h" : "v"], c = a.minPixelPadding,
                                e = a.toPixels(Math.min(F(a.options.min, a.dataMin), a.dataMin)),
                                d = a.toPixels(Math.max(F(a.options.max, a.dataMax), a.dataMax)), h = Math.max(e, d);
                    ...
                    var x = this.chart, u;
                    if (x.index !== d.hoverChartIndex) this.onContainerMouseLeave({relatedTarget: !0});
                    d.hoverChartIndex = x.index;
                    if (1 === f.touches.length) if (f = this.normalize(f), (u = x.isInsidePlot(f.chartX - x.plotLeft, f.chartY - x.plotTop)) && !x.openMenu) {
                        ...
                        F(t, !0) && this.pinch(f)
                    } else p && this.reset(); else 2 === f.touches.length && this.pinch(f)
    ...
    M(w, "parts/MSPointer.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var L = f.extend, F = f.objectEach;
        f = f.wrap;
        var A = d.addEvent, D = d.charts, x = d.css, p = d.doc, H = d.noop, u = d.Pointer, t = d.removeEvent, y = d.win;
        if (!d.hasTouch && (y.PointerEvent || y.MSPointerEvent)) {
            var k = {}, n = !!y.PointerEvent, E = function () {
                var e = [];
                e.item = function (c) {
                    return this[c]
                };
                F(k, function (c) {
                    e.push({pageX: c.pageX, pageY: c.pageY, target: c.target})
                });
                return e
            }, h = function (e, c, a, b) {
            ...
            L(u.prototype, {
                onContainerPointerDown: function (e) {
                    h(e, "onContainerTouchStart", "touchstart", function (c) {
                        k[c.pointerId] = {pageX: c.pageX, pageY: c.pageY, target: c.currentTarget}
                    })
            ...
            f(u.prototype, "init", function (e, c, a) {
                e.call(this, c, a);
                this.hasZoom &&
                x(c.container, {"-ms-touch-action": "none", "touch-action": "none"})
            });
    ...
    M(w, "parts/Legend.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var L = f.defined, F = f.discardElement, A = f.isNumber, D = f.pick, x = f.relativeLength, p = f.setAnimation,
            H = f.syncTimeout;
        f = f.wrap;
        var u = d.addEvent, t = d.css, y = d.fireEvent,
            k = d.isFirefox, n = d.marginNames, E = d.merge, h = d.stableSort, e = d.win;
        ...
        d.Legend.prototype = {
            ...
            colorizeItem: function (c, a) {
                ...
                if (c) {
                    ...
                    this.allItems.forEach(function (d) {
                        ...
                        if (g) {
                            ...
                            t(g, {
                                left: c.translateX + d.checkboxOffset + g.x - 20 + "px", top: h +
                                    "px", display: this.proximate || h > e - 6 && h < e + a - 6 ? "" : "none"
                            })
                        }
                    }, this)
                }
            }, renderTitle: function () {
                var c = this.options, a = this.padding, b = c.title, e = 0;
                b.text && (this.title || (this.title = this.chart.renderer.label(b.text, a - 3, a - 4, null, null, null, c.useHTML, null, "legend-title").attr({zIndex: 1}), this.chart.styledMode || this.title.css(b.style), this.title.add(this.group)), b.width || this.title.css({width: this.maxLegendWidth + "px"}), c = this.title.getBBox(), e = c.height, this.offsetWidth = c.width, this.contentGroup.attr({translateY: e}));
                this.titleHeight = e
            }, setText: function (c) {
                var a = this.options;
                c.legendItem.attr({text: a.labelFormat ? d.format(a.labelFormat, c, this.chart) : a.labelFormatter.call(c)})
            }, renderItem: function (c) {
                var a = this.chart, b = a.renderer, e = this.options, d = this.symbolWidth, h = e.symbolPadding,
                    f = this.itemStyle, k = this.itemHiddenStyle,
                    l = "horizontal" === e.layout ? D(e.itemDistance, 20) : 0, v = !e.rtl, B = c.legendItem,
                    I = !c.series, J = !I && c.series.drawLegendSymbol ? c.series : c, r = J.options;
                r = this.createCheckboxForItem && r && r.showCheckbox;
                l = d + h +
                    l + (r ? 20 : 0);
                var G = e.useHTML, t = c.options.className;
                B || (c.legendGroup = b.g("legend-item").addClass("highcharts-" + J.type + "-series highcharts-color-" + c.colorIndex + (t ? " " + t : "") + (I ? " highcharts-series-" + c.index : "")).attr({zIndex: 1}).add(this.scrollGroup), c.legendItem = B = b.text("", v ? d + h : -h, this.baseline || 0, G), a.styledMode || B.css(E(c.visible ? f : k)), B.attr({
                    align: v ? "left" : "right",
                    zIndex: 2
                ...
                !a.styledMode && f.width || B.css({width: (e.itemWidth || this.widthOption || a.spacingBox.width) - l});
                this.setText(c);
                a = B.getBBox();
                ...
                var a = this.options, b = this.padding, e = "horizontal" === a.layout, d = c.itemHeight,
                    h = this.itemMarginBottom, f = this.itemMarginTop, k = e ? D(a.itemDistance, 20) : 0,
                ...
                var b = this.chart, e = this.options, d = this.getAlignment();
                ...
                var c = this.chart, a = [], b = "left" === this.options.align;
                ...
                var c = this.chart, a = c.renderer, b = this.group, e, d = this.box, f = this.options, k = this.padding;
                this.itemX = k;
                this.itemY = this.initialItemY;
                this.lastItemY = this.offsetWidth = 0;
                this.widthOption = x(f.width, c.spacingBox.width - k);
                var z = c.spacingBox.width - 2 * k - f.x;
                -1 < ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) && (z /= 2);
                this.maxLegendWidth = this.widthOption || z;
                b || (this.group = b = a.g("legend").attr({zIndex: 7}).add(),
                    this.contentGroup = a.g().attr({zIndex: 1}).add(b), this.scrollGroup = a.g().add(this.contentGroup));
                this.renderTitle();
                z = this.getAllItems();
                h(z, function (a, b) {
                ...
                l += k;
                d || (this.box = d = a.rect().addClass("highcharts-legend-box").attr({r: f.borderRadius}).add(b), d.isNew = !0);
                c.styledMode || d.attr({
                ...
                this.legendHeight =
                    l;
                e && (a = c.spacingBox, d = a.y, /(lth|ct|rth)/.test(this.getAlignment()) && 0 < c.titleOffset[0] ? d += c.titleOffset[0] : /(lbh|cb|rbh)/.test(this.getAlignment()) && 0 < c.titleOffset[2] && (d -= c.titleOffset[2]), d !== a.y && (a = E(a, {y: d})), b.align(E(f, {
                    width: z,
                    height: l,
                ...
                var a = this, b = this.chart, e = b.renderer, d = this.options, h = d.y, f = this.padding;
                h = b.spacingBox.height + ("top" === d.verticalAlign ?
                    -h : h) - f;
                var k = d.maxHeight, l, v = this.clipRect, B = d.navigation, I = D(B.animation, !0),
                    J = B.arrowSize || 12, r = this.nav, G = this.pages, t, n = this.allItems, y = function (b) {
                ...
                c > h && !1 !== B.enabled ? (this.clipHeight = l = Math.max(h - 20 - this.titleHeight - f, 0), this.currentPage = D(this.currentPage, 1), this.fullHeight = c, n.forEach(function (a, b) {
                    var c = a._legendItemPos[1], e = Math.round(a.legendItem.getBBox().height), d = G.length;
                    ...
                    0), a.contentGroup.clip(v)), y(l), r || (this.nav = r = e.g().attr({zIndex: 1}).add(this.group), this.up = e.symbol("triangle", 0, 0, J, J).add(r), p("upTracker").on("click", function () {
                    a.scroll(-1, I)
                    ...
                    a.scroll(1, I)
                })), a.scroll(0), c = h) : r && (y(), this.nav = r.destroy(), this.scrollGroup.attr({translateY: 1}), this.clipHeight =
                    0);
                return c
            }, scroll: function (c, a) {
                var b = this, e = this.chart, h = this.pages, f = h.length, k = this.currentPage + c;
                c = this.clipHeight;
                var z = this.options.navigation, l = this.pager, v = this.padding;
                k > f && (k = f);
                0 < k && ("undefined" !== typeof a && p(a, e), this.nav.attr({
                    ...
                    a.attr({"class": 1 === k ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"})
                }), l.attr({text: k + "/" + f}), [this.down, this.downTracker].forEach(function (a) {
                    a.attr({
                        x: 18 +
                            this.pager.getBBox().width,
                        "class": k === f ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
                    })
                }, this), e.styledMode || (this.up.attr({fill: 1 === k ? z.inactiveColor : z.activeColor}), this.upTracker.css({cursor: 1 === k ? "default" : "pointer"}), this.down.attr({fill: k === f ? z.inactiveColor : z.activeColor}), this.downTracker.css({cursor: k === f ? "default" : "pointer"})), this.scrollOffset = -h[k - 1] + this.initialItemY, this.scrollGroup.animate({translateY: this.scrollOffset}), this.currentPage = k, this.positionCheckboxes(),
                    a = d.animObject(D(a, e.renderer.globalAnimation, !0)), H(function () {
                    y(b, "afterScroll", {currentPage: k})
                }, a.duration || 0))
            }
        };
        d.LegendSymbolMixin = {
            drawRectangle: function (c, a) {
                var b = c.symbolHeight, e = c.options.squareSymbol;
                a.legendSymbol = this.chart.renderer.rect(e ? (c.symbolWidth - b) / 2 : 0, c.baseline - b + 1, e ? b : c.symbolWidth, b, D(c.options.symbolRadius, b / 2)).addClass("highcharts-point").attr({zIndex: 3}).add(a.legendGroup)
            }, drawLineMarker: function (c) {
                var a = this.options, b = a.marker, e = c.symbolWidth, d = c.symbolHeight, h =
                    d / 2, f = this.chart.renderer, k = this.legendGroup;
                c = c.baseline - Math.round(.3 * c.fontMetrics.b);
                var l = {};
                this.chart.styledMode || (l = {"stroke-width": a.lineWidth || 0}, a.dashStyle && (l.dashstyle = a.dashStyle));
                ...
                b && !1 !== b.enabled && e && (a = Math.min(D(b.radius, h), h), 0 === this.symbol.indexOf("url") && (b = E(b, {
                    width: d,
                    height: d
                }), a = 0), this.legendSymbol = b = f.symbol(this.symbol, e / 2 - a, c - a, 2 * a, 2 * a, b).addClass("highcharts-point").add(k), b.isMarker =
                    !0)
            }
        };
    ...
    M(w, "parts/Chart.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var L = f.animObject, F = f.attr, A = f.defined, D = f.discardElement, x = f.erase, p = f.extend, H = f.isArray,
            u = f.isNumber, t = f.isObject, y = f.isString, k = f.numberFormat, n = f.objectEach, E = f.pick,
            h = f.pInt, e = f.relativeLength, c = f.setAnimation,
            a = f.splat, b = f.syncTimeout, g = d.addEvent, q = d.animate, m = d.doc, C = d.Axis, z = d.createElement,
            l = d.defaultOptions, v = d.charts, B = d.css, I = d.find, J = d.fireEvent, r = d.Legend, G = d.marginNames,
            N = d.merge, U = d.Pointer, S = d.removeEvent, w = d.seriesTypes, O = d.win, P = d.Chart = function () {
        ...
        p(P.prototype, {
            callbacks: [], getArgs: function () {
                ...
                this.init(a[0], a[1])
                               ...
                               b) {
                var c, e = a.series, h = a.plotOptions || {};
                ...
                var c = w[b];
                c || d.error(17, !0, this, {missingModuleFor: b});
                b = new c;
                b.init(this, a);
                return b
                ...
                J(this, "beforeRedraw");
                var b = this.axes, e = this.series, d = this.pointer, g = this.legend, l = this.userOptions.legend,
                    h = this.isDirtyLegend, f = this.hasCartesianSeries, v = this.isDirtyBox, m = this.renderer,
                    r = m.isHidden(), B = [];
                ...
                var b = this, c = this.options, e = c.xAxis = a(c.xAxis || {});
                c = c.yAxis = a(c.yAxis || {});
                J(this, "getAxes");
                ...
                var c = this, e = "title" === a ? {
                    color: "#333333",
                    fontSize: this.options.isStock ? "16px" : "18px"
                } : {color: "#666666"};
                e = this.options[a] = N(!this.styledMode && {style: e}, this.options[a], b);
                var d = this[a];
                ...
                var b = [0, 0, 0], c = this.renderer, e = this.spacingBox;
                ["title", "subtitle", "caption"].forEach(function (a) {
                    var d = this[a], g = this.options[a], l = g.verticalAlign || "top";
                    a = "title" === a ? -3 : "top" === l ? b[0] + 2 : 0;
                    if (d) {
                        if (!this.styledMode) var h =
                            g.style.fontSize;
                        h = c.fontMetrics(h, d).b;
                        d.css({width: (g.width || e.width + (g.widthAdjust || 0)) + "px"});
                        var f = Math.round(d.getBBox(g.useHTML).height);
                        d.align(p({y: "bottom" === l ? h : a + h, height: f}, g), !1, "spacingBox");
                ...
                var b = this.renderTo;
                if (a) for (; b && b.style;) b.hcOrigStyle && (d.css(b, b.hcOrigStyle), delete b.hcOrigStyle), b.hcOrigDetached && (m.body.removeChild(b), b.hcOrigDetached = !1), b = b.parentNode; else for (; b && b.style;) {
                ...
                this.container = c = z("div", {id: e}, g, c);
                ...
                if (this.styledMode) for (l in a.defs) this.renderer.definition(a.defs[l]); else this.renderer.setStyle(b.style);
                ...
                var a = this, b = a.axisOffset = [0, 0, 0, 0], c = a.colorAxis, e = a.margin, d = function (a) {
                    a.forEach(function (a) {
                ...
                var c = this, e = c.options.chart, g = c.renderTo, l = A(e.width) && A(e.height),
                ...
                if (!g.styledMode) {
                    ...
                    (h ? q : B)(g.container, {width: g.chartWidth + "px", height: g.chartHeight + "px"}, h)
                }
                g.setChartSize(!0);
                ...
                var b = this.inverted, c = this.renderer, e = this.chartWidth, d = this.chartHeight,
                    g = this.options.chart, l = this.spacing, h = this.clipOffset, f, v, m, r;
                ...
                this.spacingBox = c.spacingBox = {x: l[3], y: l[0], width: e - l[3] - l[1], height: d - l[0] - l[2]};
                this.plotBox = c.plotBox = {x: f, y: v, width: m, height: r};
                ...
                var a =
                        this.options.chart, b = this.renderer, c = this.chartWidth, e = this.chartHeight,
                    d = this.chartBackground, g = this.plotBackground, l = this.plotBorder, h = this.styledMode,
                    f = this.plotBGImage, v = a.backgroundColor, m = a.plotBackgroundColor, r = a.plotBackgroundImage,
                    k, B = this.plotLeft, q = this.plotTop, z = this.plotWidth, I = this.plotHeight, G = this.plotBox,
                    t = this.clipRect, n = this.clipBox, y = "animate";
                d || (this.chartBackground = d = b.rect().addClass("highcharts-background").add(), y = "attr");
                if (h) var C = k = d.strokeWidth(); else {
                    C = a.borderWidth ||
                        0;
                    k = C + (a.shadow ? 8 : 0);
                    v = {fill: v || "none"};
                ...
                d[y]({x: k / 2, y: k / 2, width: c - k - C % 2, height: e - k - C % 2, r: a.borderRadius});
                y = "animate";
                g || (y = "attr", this.plotBackground = g = b.rect().addClass("highcharts-plot-background").add());
                g[y](G);
                h || (g.attr({fill: m || "none"}).shadow(a.plotShadow), r && (f ? (r !== f.attr("href") && f.attr("href", r), f.animate(G)) : this.plotBGImage = b.image(r, B, q, z, I).add()));
                t ? t.animate({width: n.width, height: n.height}) :
                    this.clipRect = b.clipRect(n);
                y = "animate";
                l || (y = "attr", this.plotBorder = l = b.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add());
                h || l.attr({stroke: a.plotBorderColor, "stroke-width": a.plotBorderWidth || 0, fill: "none"});
                l[y](l.crisp({x: B, y: q, width: z, height: I}, -l.strokeWidth()));
                this.isDirtyBox = !1;
                ...
                b.items && b.items.forEach(function (c) {
                    var e = p(b.style, c.style), d = h(e.left) + a.plotLeft, g = h(e.top) + a.plotTop + 12;
                    delete e.left;
                    delete e.top;
                    a.renderer.text(c.html, d, g).attr({zIndex: 2}).css(e).add()
                })
            }, render: function () {
                var a = this.axes, b = this.colorAxis, c = this.renderer, e = this.options, d = 0, g = function (a) {
                    a.forEach(function (a) {
                        a.visible && a.render()
                    })
                };
                ...
                this.seriesGroup || (this.seriesGroup =
                    c.g("series-group").attr({zIndex: 3}).add());
                this.renderSeries();
                this.renderLabels();
                this.addCredits();
                ...
                var a = this, b = a.axes, c = a.series, e = a.container, g, l = e && e.parentNode;
                J(a, "destroy");
    ...
    M(w, "parts/ScrollablePlotArea.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w = f.pick, F = d.addEvent;
        f = d.Chart;
        "";
        F(f, "afterSetChartSize", function (f) {
            var A = this.options.chart.scrollablePlotArea, x = A && A.minWidth;
            A = A && A.minHeight;
        ...
        f.prototype.setUpScrolling = function () {
            ...
            this.scrollingContainer = d.createElement("div", {className: "highcharts-scrolling"}, f, this.renderTo);
            this.innerContainer = d.createElement("div", {className: "highcharts-inner-container"}, null, this.scrollingContainer);
            this.innerContainer.appendChild(this.container);
            this.setUpScrolling = null
        };
        f.prototype.moveFixedElements = function () {
            var d = this.container, f = this.fixedRenderer,
        ...
        f.prototype.applyFixed = function () {
            var f, D = !this.fixedDiv, x = this.options.chart.scrollablePlotArea;
            D ? (this.fixedDiv = d.createElement("div", {className: "highcharts-fixed"}, {
                position: "absolute",
                overflow: "hidden",
                pointerEvents: "none",
                zIndex: 2
            ...
            this.renderer.boxWrapper.attr({width: f, height: p, viewBox: [0, 0, f, p].join(" ")});
            this.chartBackground.attr({width: f, height: p});
            ...
            var H = this.plotLeft + this.plotWidth - (this.scrollablePixelsX || 0), u = this.plotTop + this.plotHeight -
    ...
    M(w, "parts/Point.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w =
                f.animObject, F = f.defined, A = f.erase, D = f.extend, x = f.isArray, p = f.isNumber, H = f.isObject,
            u = f.syncTimeout, t = f.pick, y, k = d.fireEvent, n = d.format, E = d.uniqueKey, h = d.removeEvent;
        d.Point = y = function () {
        };
        d.Point.prototype = {
            init: function (e, c, a) {
                ...
                var a = this.series, b = a.options.pointValKey || a.pointValKey;
                ...
                var c =
                        {}, a = this.series, b = a.options.keys, g = b || a.pointArrayMap || ["y"], h = g.length, f = 0,
                    k = 0;
                if (p(e) || null === e) c[g[0]] = e; else if (x(e)) for (!b && e.length > h && (a = typeof e[0], "string" === a ? c.name = e[0] : "number" === a && (c.x = e[0]), f++); k < h;) b && "undefined" === typeof e[f] || (0 < g[k].indexOf(".") ? d.Point.prototype.setNestedProperty(c, e[f], g[k]) : c[g[k]] = e[f]), f++, k++; else "object" === typeof e && (c = e, e.dataLabels && (a._hasPointLabels = !0), e.marker && (a._hasPointMarkers = !0));
                return c
                ...
                var c = this, a = c.series, b = a.chart;
                a = a.options.dataSorting;
                var d = b.hoverPoints, f = w(c.series.chart.renderer.globalAnimation),
                    m;
                a && a.enabled ? (this.animateBeforeDestroy(), u(e, f.duration)) : e();
                b.pointCount--;
                c.legendItem && b.legend.destroyItem(c)
            }, animateBeforeDestroy: function () {
                var e = this, c = {x: e.startXPos, opacity: 0}, a, b = e.getGraphicalProps();
                b.singular.forEach(function (b) {
                    a = "dataLabel" === b;
                    e[b] = e[b].animate(a ? {x: e[b].startXPos, y: e[b].startYPos, opacity: 0} : c)
                });
                b.plural.forEach(function (a) {
                    e[a].forEach(function (a) {
                        a.element && a.animate(D({x: e.startXPos}, a.startYPos ? {x: a.startXPos, y: a.startYPos} : {}))
                    })
                })
                ...
                var c = this, a = [], b, d = {singular: [], plural: []};
                ...
                var c = this.series, a = c.tooltipOptions, b = t(a.valueDecimals, ""), d = a.valuePrefix || "",
                    h = a.valueSuffix || "";
                ...
                return n(e, {point: this, series: this.series}, c.chart)
    ...
    M(w, "parts/Series.js", [w["parts/Globals.js"], w["parts/Utilities.js"]],
        function (d, f) {
            var w = f.animObject, F = f.arrayMax, A = f.arrayMin, D = f.clamp, x = f.correctFloat, p = f.defined,
                H = f.erase, u = f.extend, t = f.isArray, y = f.isNumber, k = f.isString, n = f.objectEach, E = f.pick,
                h = f.splat, e = f.syncTimeout, c = d.addEvent, a = d.defaultOptions, b = d.defaultPlotOptions,
                g = d.fireEvent, q = d.merge, m = d.removeEvent, C = d.SVGElement, z = d.win;
            d.Series = d.seriesType("line", null, {
                ...
                init: function (a, b) {
                    ...
                    e.linkedSeries = [];
                    e.bindAxes();
                    u(e, {name: b.name, state: "", visible: !1 !== b.visible, selected: !0 === b.selected});
                    var f = b.events;
                    n(f, function (a, b) {
                ...
                updateParallelArrays: function (a, b) {
                    var c = a.series, e = arguments, d = y(b) ? function (e) {
                ...
                setOptions: function (b) {
                    var c = this.chart, e = c.options, d = e.plotOptions, l = c.userOptions || {};
                    b = q(b);
                    c = c.styledMode;
                    var h = {plotOptions: d, userOptions: b};
                    g(this, "setOptions", h);
                    var f = h.plotOptions[this.type], m = l.plotOptions || {};
                ...
                getCyclic: function (a,
                                     b, c) {
                    var e = this.chart, d = this.userOptions, g = a + "Index", l = a + "Counter",
                ...
                findPointIndex: function (a, b) {
                    var c = a.id, e = a.x, g = this.points, l, h = this.options.dataSorting;
                    if (c) var f = this.chart.get(c); else if (this.linkedParent || this.enabledDataSorting) {
                    ...
                    "undefined" === typeof v && y(e) && (v = this.xData.indexOf(e, b));
                    -1 !== v && "undefined" !== typeof v && this.cropped && (v = v >= this.cropStart ?
                        v - this.cropStart : v);
                ...
                updateData: function (a, b) {
                    var c = this.options, e = c.dataSorting, d = this.points, g = [], l, h, f, m = this.requireSorting,
                        v = a.length === d.length, k = !0;
                    this.xIncrement = null;
                    a.forEach(function (a, b) {
                        var h = p(a) && this.pointClass.prototype.optionsToObject.call({series: this}, a) || {};
                        var k = h.x;
                        if (h.id || y(k)) {
                    ...
                    if (l) for (a = d.length; a--;) (h = d[a]) && !h.touched && h.remove && h.remove(!1, b); else !v || e && e.enabled ? k = !1 : (a.forEach(function (a, b) {
                ...
                setData: function (a, b, c, e) {
                    var g = this, l = g.points, h = l && l.length || 0, f, m = g.options, v = g.chart,
                        q = m.dataSorting, B = null, z = g.xAxis;
                    B = m.turboThreshold;
                    var I = this.xData, n = this.yData, C = (f = g.pointArrayMap) && f.length, p = m.keys, u = 0, x = 1,
                        A;
                    a = a || [];
                    f = a.length;
                    b = E(b, !0);
                ...
                sortData: function (a) {
                    var b = this, c = b.options.dataSorting.sortKey || "y", e = function (a, b) {
                        return p(b) && a.pointClass.prototype.optionsToObject.call({series: a}, b) || {}
                    };
                ...
                processData: function (a) {
                    var b = this.xData, c = this.yData, e = b.length;
                    var g = 0;
                    var l = this.xAxis, h = this.options;
                    var f = h.cropThreshold;
                    var m = this.getExtremesFromAll || h.getExtremesFromAll, k = this.isCartesian;
                    h = l && l.val2lin;
                    var q = l && l.isLog, z = this.requireSorting;
                    ...
                    if (k && this.sorted && !m && (!f || e > f || this.forceCrop)) if (b[e - 1] < t || b[0] > n) b = [], c = []; else if (this.yData && (b[0] < t || b[e - 1] > n)) {
                    ...
                    for (f = b.length || 1; --f;) if (e = q ? h(b[f]) - h(b[f - 1]) : b[f] - b[f - 1], 0 < e && ("undefined" === typeof C || e < C)) var C = e; else 0 > e && z && (d.error(15, !1, this.chart), z = !1);
                    this.cropped = y;
                    this.cropStart = g;
                    this.processedXData =
                        b;
                ...
                cropData: function (a, b, c, e, d) {
                    var g = a.length, l = 0, h = g, f;
                    d = E(d, this.cropShoulder);
                    for (f = 0; f < g; f++) if (a[f] >= c) {
                        l = Math.max(0, f - d);
                        break
                    }
                    for (c = f; c < g; c++) if (a[c] > e) {
                        h = c + d;
                        break
                    }
                ...
                generatePoints: function () {
                    var a = this.options, b = a.data, c = this.data, e, d = this.processedXData,
                        f = this.processedYData, m = this.pointClass, k = d.length, q = this.cropStart || 0,
                    ...
                    this.options.keys = a;
                    if (c && (k !== (e = c.length) || z)) for (n = 0; n < e; n++) n !== q || z || (n += k), c[n] && (c[n].destroyElements(), c[n].plotX =
                        void 0);
                    this.data = c;
                    this.points = t;
                ...
                getXExtremes: function (a) {
                    return {min: A(a), max: F(a)}
                },
                getExtremes: function (a) {
                    var b = this.xAxis, c = this.yAxis, e = this.processedXData || this.xData, d = [], l = 0, h = 0;
                    var f = 0;
                    var m = this.requireSorting ? this.cropShoulder : 0, k = c ? c.positiveValuesOnly : !1, q;
                    ...
                    for (q = 0; q < c; q++) {
                        ...
                        if (C && z) if (C = n.length) for (; C--;) y(n[C]) && (d[l++] = n[C]); else d[l++] = n
                    }
                    this.dataMin = A(d);
                    this.dataMax = F(d);
                ...
                translate: function () {
                    ...
                    this.generatePoints();
                    var a = this.options, b = a.stacking, c = this.xAxis, e = c.categories, d = this.enabledDataSorting,
                        h = this.yAxis, f = this.points,
                        m = f.length, k = !!this.modifyValue, q, z = this.pointPlacementToXValue(), n = y(z),
                        C = a.threshold, u = a.startFromThreshold ? C : 0, A, H = this.zoneAxis || "y",
                        F = Number.MAX_VALUE;
                    for (q = 0; q < m; q++) {
                        var w = f[q], L = w.x;
                        var T = w.y;
                ...
                getClipBox: function (a, b) {
                    var c = this.options, e = this.chart, d = e.inverted, g = this.xAxis, l = g && this.yAxis;
                    a && !1 === c.clip && l ? a = d ? {
                ...
                setClip: function (a) {
                    var b = this.chart, c = this.options, e = b.renderer, d = b.inverted,
                        g = this.clipBox, l = this.getClipBox(a),
                        h = this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, l.height, c.xAxis, c.yAxis].join(),
                        f = b[h], m = b[h + "m"];
                    f || (a && (l.width = 0, d && (l.x = b.plotSizeX + (!1 !== c.clip ? 0 : b.plotTop)), b[h + "m"] = m = e.clipRect(d ? b.plotSizeX + 99 : -99, d ? -b.plotLeft : -b.plotTop, 99, d ? b.chartWidth : b.chartHeight)), b[h] = f = e.clipRect(l), f.count = {length: 0});
                ...
                animate: function (a) {
                    var b = this.chart, c = w(this.options.animation);
                    if (a) this.setClip(c); else {
                        var e = this.sharedClipKey;
                        a = b[e];
                        var d = this.getClipBox(c, !0);
                        a && a.animate(d, c);
                        b[e + "m"] && b[e + "m"].animate({width: d.width + 99, x: d.x - (b.inverted ? 0 : 99)}, c);
                        this.animate = null
                    }
                },
                ...
                drawPoints: function () {
                    var a = this.points, b = this.chart, c, e, d = this.options.marker,
                        g = this[this.specialGroup] || this.markerGroup, h = this.xAxis,
                        f = E(d.enabled, !h || h.isRadial ? !0 : null, this.closestPointRangePx >= d.enabledThreshold * d.radius);
                    if (!1 !== d.enabled || this._hasPointMarkers) for (c = 0; c < a.length; c++) {
                        var m = a[c];
                        ...
                        if ((f && "undefined" === typeof q.enabled || q.enabled) && !m.isNull && !1 !== m.visible) {
                            ...
                            var C = !1 !== m.isInside;
                            e ? e[C ? "show" : "hide"](C).animate(n) : C && (0 < n.width || m.hasImage) && (m.graphic = e = b.renderer.symbol(t, n.x, n.y, n.width, n.height, z ? q : d).add(g), this.enabledDataSorting && b.hasRendered && (e.attr({x: m.startXPos}), k = "animate"));
                ...
                markerAttribs: function (a, b) {
                    var c = this.options.marker, e = a.marker || {}, d = e.symbol || c.symbol,
                ...
                pointAttribs: function (a, b) {
                    ...
                    return {stroke: g, "stroke-width": e, fill: l, opacity: a}
                },
                destroy: function (a) {
                    var b = this, c = b.chart, e = /AppleWebKit\/533/.test(z.navigator.userAgent), l, h, f = b.data ||
                        [], m, k;
                    g(b, "destroy");
                    this.removeEvents(a);
                ...
                getGraphPath: function (a, b, c) {
                    ...
                    a.forEach(function (h, k) {
                        ...
                        h.isNull && !p(b) && 0 < k ? m = !d.connectNulls : h.isNull && !b ? m = !0 : (0 === k || m ? k = ["M", h.plotX, h.plotY] : e.getPointSpline ? k = e.getPointSpline(a, h, k) : g ? (k = 1 === g ? ["L", r.plotX, v] : 2 === g ? ["L", (r.plotX + q) / 2,
                            r.plotY, "L", (r.plotX + q) / 2, v] : ["L", q, r.plotY], k.push("L", q, v)) : k = ["L", q, v], f.push(h.x), g && (f.push(h.x), 2 === g && f.push(h.x)), l.push.apply(l, k), m = !1)
                    });
                    l.xMap = f;
                ...
                drawGraph: function () {
                    ...
                    d.forEach(function (d, g) {
                        var h = d[0], l = a[h], f = l ? "animate" : "attr";
                        l ? (l.endX = a.preventGraphAnimation ?
                            null : c.xMap, l.animate({d: c})) : c.length && (a[h] = l = a.chart.renderer.path(c).addClass(d[1]).attr({zIndex: 1}).add(a.group));
                        l && !e && (h = {
                            stroke: d[2],
                ...
                applyZones: function () {
                    var a = this, b = this.chart, c = b.renderer, e = this.zones, d, g, h = this.clips || [], f,
                        m = this.graph, k = this.area, q = Math.max(b.chartWidth, b.chartHeight),
                        z = this[(this.zoneAxis || "y") + "Axis"], n = b.inverted, t, C, y, p = !1;
                ...
                render: function () {
                    var a = this, b = a.chart, c = a.options,
                        ...
                        h = a.visible ? "inherit" : "hidden", f = c.zIndex, m = a.hasRendered, k = b.seriesGroup,
                        q = b.inverted;
                    g(this, "render");
                ...
                searchPoint: function (a, b) {
                    ...
                    return this.searchKDTree({
                        clientX: d ? c.len - a.chartY + c.pos : a.chartX -
                            c.pos, plotY: d ? e.len - a.chartX + e.pos : a.chartY - e.pos
                    }, b, a)
                },
                buildKDTree: function (a) {
                    function b(a, e, d) {
                        ...
                        if (g = a && a.length) {
                            ...
                            g = Math.floor(g / 2);
                            return {point: a[g], left: b(a.slice(0, g), e + 1, d), right: b(a.slice(g + 1), e + 1, d)}
                        }
                    }
                ...
                searchKDTree: function (a, b, c) {
                    function e(a, b, c, l) {
                        var m = b.point, k = d.kdAxisArray[c % l], q = m;
                    ...
                    var d = this, g = this.kdAxisArray[0],
                        h = this.kdAxisArray[1], f = b ? "distX" : "dist";
    ...
    M(w, "parts/Stacking.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w = f.correctFloat, F = f.defined, A = f.destroyObjectProperties,
            D = f.objectEach, x = f.pick;
        f = d.Axis;
        var p = d.Chart, H = d.format, u = d.Series;
        ...
        d.StackItem.prototype = {
            destroy: function () {
                ...
                var f = this.axis.chart, k = this.options, n = k.format;
                ...
                var c = f.axis.reversed, a = d.inverted;
                d = e.height + e.pos - (a ? d.plotLeft : d.plotTop);
                f = f.isNegative && !c || !f.isNegative && c;
                return {
                    x: a ? f ? n : n - h : k, y: a ? d - k - p : f ? d - n - h : d - n, width: a ?
                        h : p, height: a ? p : h
                }
            }
        };
        p.prototype.getStacks = function () {
            var d = this, f = d.inverted;
        ...
        f.prototype.buildStacks = function () {
            var f = this.series, p = x(this.options.reversedStacks, !0), k = f.length, n;
            if (!this.isXAxis) {
                this.usePercentage =
                    !1;
                for (n = k; n--;) {
        ...
        f.prototype.renderStackTotals = function () {
            var d = this.chart, f = d.renderer, k = this.stacks, n = this.stackTotalGroup;
        ...
        u.prototype.setStackedPoints = function () {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var f = this.processedXData, p = this.processedYData, k = [], n = p.length, u = this.options,
                    h = u.threshold, e = x(u.startFromThreshold &&
                    h, 0), c = u.stack;
                u = u.stacking;
                var a = this.stackKey, b = "-" + a, g = this.negStacks, q = this.yAxis, m = q.stacks, C = q.oldStacks,
                    z, l;
                q.stacksTouched += 1;
                for (l = 0; l < n; l++) {
                    var v = f[l];
        ...
        u.prototype.modifyStacks =
            function () {
                var d = this, f = d.stackKey, k = d.yAxis.stacks, n = d.processedXData, p, h = d.options.stacking;
                d[h + "Stacker"] && [f, "-" + f].forEach(function (e) {
                    for (var c = n.length, a, b; c--;) if (a = n[c], p = d.getStackIndicator(p, a, d.index, e), b = (a = k[e] && k[e][a]) && a.points[p.key]) d[h + "Stacker"](b, a, c)
                })
            };
        ...
        u.prototype.getStackIndicator = function (d, f, k, n) {
            !F(d) || d.x !== f || n && d.key !== n ? d = {x: f, index: 0, key: n} : d.index++;
            d.key = [k, f, d.index].join();
            return d
        }
    });
    M(w, "parts/Dynamics.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w = f.defined, F = f.erase, A = f.extend, D = f.isArray, x = f.isNumber, p = f.isObject, H = f.isString,
            u = f.objectEach, t = f.pick, y = f.relativeLength, k = f.setAnimation, n = f.splat, E = d.addEvent,
            h = d.animate, e = d.Axis;
        f = d.Chart;
        var c = d.createElement, a = d.css, b = d.fireEvent, g = d.merge, q = d.Point, m = d.Series, C = d.seriesTypes;
        d.cleanRecursively = function (a, b) {
            var c = {};
            u(a, function (e, g) {
                if (p(a[g], !0) && !a.nodeType &&
                    b[g]) e = d.cleanRecursively(a[g], b[g]), Object.keys(e).length && (c[g] = e); else if (p(a[g]) || a[g] !== b[g]) c[g] = a[g]
            });
            return c
        };
        A(f.prototype, {
            addSeries: function (a, c, e) {
                var d, g = this;
                a && (c = t(c, !0), b(g, "addSeries", {options: a}, function () {
                    d = g.initSeries(a);
                    g.isDirtyLegend = !0;
                    g.linkSeries();
                    d.enabledDataSorting && d.setData(a.data, !1);
                    b(g, "afterAddSeries", {series: d});
                    c && g.redraw(e)
                }));
                return d
            },
            addAxis: function (a, b, c, e) {
                return this.createAxis(b ? "xAxis" : "yAxis", {axis: a, redraw: c, animation: e})
            },
            ...
            createAxis: function (a, b) {
                var c = this.options, f = "colorAxis" === a, h = b.redraw, l = b.animation;
                b = g(b.axis, {index: this[a].length, isX: "xAxis" === a});
            ...
            showLoading: function (b) {
                var e = this, d = e.options,
                    g = e.loadingDiv, f = d.loading, m = function () {
                        g && a(g, {
                            left: e.plotLeft + "px",
                            top: e.plotTop + "px",
                ...
                g || (e.loadingDiv = g = c("div", {className: "highcharts-loading highcharts-loading-hidden"}, null, e.container), e.loadingSpan = c("span", {className: "highcharts-loading-inner"}, null, g), E(e, "redraw", m));
                g.className = "highcharts-loading";
                e.loadingSpan.innerHTML = t(b, d.lang.loading, "");
                e.styledMode || (a(g, A(f.style, {zIndex: 10})), a(e.loadingSpan, f.labelStyle), e.loadingShown || (a(g,
                    {
                        opacity: 0,
                        display: ""
                    }), h(g, {opacity: f.style.opacity || .5}, {duration: f.showDuration || 0})));
                e.loadingShown = !0;
                m()
            },
            hideLoading: function () {
                var b = this.options, c = this.loadingDiv;
                c && (c.className = "highcharts-loading highcharts-loading-hidden", this.styledMode || h(c, {opacity: 0}, {
            ...
            update: function (a, c, e, f) {
                var h = this,
                    l = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle", caption: "setCaption"}, m,
                    k, q, z = a.isResponsiveOptions, v = [];
                b(h, "update",
                    {options: a});
                ...
                if (m = a.chart) {
                    ...
                    "alignTicks" in m && (C = !0);
                    u(m, function (a, b) {
                        -1 !== h.propsRequireUpdateSeries.indexOf("chart." + b) && (k = !0);
                ...
                u(a, function (a, b) {
                    if (h[b] && "function" === typeof h[b].update) h[b].update(a, !1); else if ("function" === typeof h[l[b]]) h[l[b]](a);
                ...
                b(h, "afterUpdate", {options: a, redraw: c, animation: f})
            },
        ...
        f.prototype.collectionsWithInit =
            {xAxis: [f.prototype.addAxis, [!0]], yAxis: [f.prototype.addAxis, [!1]], series: [f.prototype.addSeries]};
        A(q.prototype, {
            update: function (a, b, c, e) {
                ...
                var g = this, f = g.series, h = g.graphic, l, m = f.chart, k = f.options;
                b = t(b, !0);
        ...
        A(m.prototype, {
            addPoint: function (a, c, e, d, g) {
                var f = this.options, h = this.data, l = this.chart, m = this.xAxis;
                ...
                var n = z.x;
                var C = q.length;
                if (this.requireSorting && n < q[C - 1]) for (v = !0; C && q[C - 1] > n;) C--;
                ...
                var e = this, d = e.data, g = d[a], f = e.points, h = e.chart, l = function () {
                ...
                var e = this, f = e.chart, h = e.userOptions, l = e.initialType || e.type,
                    ...
                    p = ["eventOptions", "navigatorSeries", "baseSeries"], y = e.finishedAnimating && {animation: !1},
                    u = {};
                ...
                a = g(h, y, {
                    index: "undefined" === typeof h.index ? e.index :
                        h.index, pointStart: t(h.pointStart, e.xData[0])
                }, !k && {data: e.options.data}, a);
                ...
                C[m || l] ? A(e, C[m || l].prototype) : d.error(17, !0, f, {missingModuleFor: m || l});
                p.forEach(function (a) {
                    e[a] = p[a]
                });
                e.init(f, a);
    ...
    M(w, "parts/AreaSeries.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w = f.objectEach, F = f.pick, A = d.color, D = d.Series;
        f = d.seriesType;
        f("area", "line", {softThreshold: !1, threshold: 0}, {
            singleStacks: !1, getStackPoints: function (d) {
                var f =
                    ...
                    A = t.series, h = A.length, e = F(t.options.reversedStacks, !0) ? 1 : -1, c;
                d = d || this.points;
                if (this.options.stacking) {
                    ...
                    x.forEach(function (b, d) {
                        ...
                        if (k[b] && !k[b].isNull) f.push(k[b]), [-1, 1].forEach(function (g) {
                            var f = 1 === g ? "rightNull" :
                                "leftNull", q = 0, z = y[x[d + g]];
                            if (z) for (c = n; 0 <= c && c < h;) m = z.points[c], m || (c === n ? k[b][f] = !0 : a[c] && (C = y[b].points[c]) && (q -= C[1] - C[0])), c += e;
                            ...
                            f.push({isNull: !0, plotX: u.translate(b, 0, 0, 0, 1), x: b, plotY: g, yBottom: g})
                        }
                    })
                }
                return f
            }, getGraphPath: function (d) {
                var f = D.prototype.getGraphPath, x = this.options, u = x.stacking, t = this.yAxis, y, k = [], n = [],
                    A = this.index, h = t.stacks[this.stackKey], e = x.threshold,
                ...
                var a = function (a, b, f) {
                    ...
                    "undefined" !== typeof z && (n.push({
                        ...
                        isNull: m,
                        isCliff: !0
                    }), k.push({plotX: g, plotY: null === C ? c : t.getThreshold(C), doCurve: !1}))
                };
                d = d || this.points;
                ...
                var d = this, f = this.areaPath, H = this.options,
                    u = [["area", "highcharts-area", this.color, H.fillColor]];
                ...
                u.forEach(function (p) {
                    var t = p[0], k = d[t], n = k ? "animate" : "attr", u = {};
                    k ? (k.endX = d.preventGraphAnimation ? null : f.xMap, k.animate({d: f})) : (u.zIndex = 0, k = d[t] = d.chart.renderer.path(f).addClass(p[1]).add(d.group), k.isArea = !0);
    ...
    M(w, "parts/SplineSeries.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        ...
        d("spline", "line", {}, {
            getPointSpline: function (d, f, D) {
                var x = f.plotX, p = f.plotY, A = d[D - 1];
                D = d[D + 1];
    ...
    M(w, "parts/AreaSplineSeries.js", [w["parts/Globals.js"]], function (d) {
        var f = d.seriesTypes.area.prototype, w = d.seriesType;
        w("areaspline", "spline",
    ...
    M(w, "parts/ColumnSeries.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w = f.animObject, F = f.clamp, A = f.defined, D = f.extend, x = f.isNumber, p = f.pick, H = d.color,
            u = d.merge, t = d.Series;
        f = d.seriesType;
        var y = d.svg;
        f("column", "line", {
            borderRadius: 0,
            ...
            getColumnMetrics: function () {
                var d = this, f = d.options, t = d.xAxis, h = d.yAxis, e = t.options.reversedStacks;
                e = t.reversed && !e || !t.reversed && e;
                var c, a = {}, b = 0;
                !1 === f.grouping ? b = 1 : d.chart.series.forEach(function (e) {
                    var g = e.yAxis, f = e.options;
                ...
                var g = Math.min(Math.abs(t.transA) * (t.ordinalSlope ||
                    f.pointRange || t.closestPointRange || t.tickInterval || 1), t.len), q = g * f.groupPadding,
                    m = (g - 2 * q) / (b || 1);
            ...
            crispCol: function (d, f, t, h) {
                var e = this.chart, c = this.borderWidth, a = -(c % 2 ? .5 : 0);
                c = c % 2 ? .5 : 1;
                ...
                h -= f;
                a && h && (--f, h += 1);
                return {x: d, y: f, width: t, height: h}
            },
            translate: function () {
                var d = this, f = d.chart, u = d.options, h = d.dense = 2 > d.closestPointRange * d.xAxis.transA;
                h = d.borderWidth = p(u.borderWidth, h ? 0 : 1);
                var e = d.yAxis, c = u.threshold, a = d.translatedThreshold = e.getThreshold(c),
                    b = p(u.minPointLength, 5), g = d.getColumnMetrics(), q = g.width,
                    m = d.barW = Math.max(q, 1 + 2 * h), C = d.pointXOffset = g.offset, z = d.dataMin, l = d.dataMax;
                f.inverted && (a -= .5);
                u.pointPadding && (m = Math.ceil(m));
                t.prototype.translate.apply(d);
                d.points.forEach(function (g) {
                    var h = p(g.yBottom, a), k = 999 + Math.abs(h), v = q;
                    k = F(g.plotY, -k, e.len + k);
                    var r = g.plotX + C, n = m, t = Math.min(k, h), u = Math.max(k, h) - t;
                    if (b && Math.abs(u) < b) {
                        u = b;
            ...
            pointAttribs: function (d, f) {
                var k = this.options, h = this.pointAttrToOptions || {};
                var e = h.stroke || "borderColor";
                var c = h["stroke-width"] || "borderWidth", a = d && d.color || this.color,
                    b = d && d[e] || k[e] || this.color || a, g = d && d[c] ||
                    k[c] || this[c] || 0;
                ...
                e = {fill: a, stroke: b, "stroke-width": g, opacity: q};
                h && (e.dashstyle = h);
                return e
            },
            drawPoints: function () {
                var d = this, f = this.chart, t = d.options, h = f.renderer, e = t.animationLimit || 250, c;
                d.points.forEach(function (a) {
                    var b = a.graphic, g = !!b, k = b && f.pointCount < e ? "animate" : "attr";
                    if (x(a.plotY) && null !== a.y) {
                        ...
                        b || (a.graphic = b = h[a.shapeType](c).add(a.group || d.group)) && d.enabledDataSorting && f.hasRendered && f.pointCount < e && (b.attr({x: a.startXPos}),
                            g = !0, k = "animate");
                        if (b && g) b[k](u(c));
                        if (t.borderRadius) b[k]({r: t.borderRadius});
            ...
            animate: function (d) {
                var f = this, k = this.yAxis, h = f.options, e = this.chart.inverted, c = {},
                    a = e ? "translateX" : "translateY";
                if (y) if (d) c.scaleY = .001, d = F(k.toPixels(h.threshold), k.pos, k.pos + k.len), e ? c.translateX = d - k.len : c.translateY = d, f.clipBox &&
                f.setClip(), f.group.attr(c); else {
                    var b = f.group.attr(a);
                    f.group.animate({scaleY: 1}, D(w(f.options.animation), {
                        step: function (e, d) {
                            c[a] = b + d.pos * (k.pos - b);
                            f.group.attr(c)
                        }
        ...
        function (d) {
            ...
            w("scatter", "line", {
                ...
                applyJitter: function () {
                    var d = this, f = this.options.jitter, D = this.points.length;
    ...
    M(w, "mixins/centered-series.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w = f.isNumber, F = f.pick, A = f.relativeLength, D = d.deg2rad;
        d.CenteredSeriesMixin = {
            getCenter: function () {
                var d = this.options, f = this.chart, w = 2 * (d.slicedOffset || 0), u = f.plotWidth - 2 * w;
                f = f.plotHeight - 2 * w;
                var t = d.center;
                t = [F(t[0], "50%"), F(t[1], "50%"), d.size || "100%", d.innerSize || 0];
                var y = Math.min(u, f), k;
                for (k = 0; 4 > k; ++k) {
                    var n = t[k];
                    d = 2 > k || 2 === k && /%$/.test(n);
                ...
                return {start: D * (d + -90), end: D * (f + -90)}
            }
        }
    });
    M(w, "parts/PieSeries.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w = f.clamp, F = f.defined, A = f.isNumber, D = f.pick, x = f.relativeLength, p = f.setAnimation,
            H = d.addEvent;
        f = d.CenteredSeriesMixin;
        var u = f.getStartAndEndRadians, t = d.merge, y = d.noop, k = d.Point, n = d.Series, E = d.seriesType,
            h = d.fireEvent;
        E("pie", "line", {
            center: [null, null],
            clip: !1,
            ...
            animate: function (e) {
                var c = this, a = c.points, b = c.startAngleRad;
                e || (a.forEach(function (a) {
                    ...
                    }), e.animate({r: d.r, start: d.start, end: d.end}, c.options.animation))
                }), c.animate = null)
            },
            hasData: function () {
            ...
            updateTotals: function () {
                var e, c = 0, a = this.points, b = a.length, d = this.options.ignoreHiddenPoint;
                for (e = 0; e < b; e++) {
                    var f = a[e];
            ...
            getX: function (e, c, a) {
                var b = this.center, d = this.radii ? this.radii[a.index] : b[2] / 2;
            ...
            translate: function (e) {
                this.generatePoints();
                var c = 0, a = this.options, b = a.slicedOffset, d = b + (a.borderWidth || 0),
                    f = u(a.startAngle, a.endAngle), m = this.startAngleRad = f.start;
                f = (this.endAngleRad = f.end) - m;
                var k = this.points, z = a.dataLabels.distance;
                ...
                for (l = 0; l < v; l++) {
                    ...
                    n.labelPosition = {
                        natural: {
                            x: e[0] +
                                r + Math.cos(p) * n.labelDistance, y: e[1] + y + Math.sin(p) * n.labelDistance
                        },
                        "final": {},
                        alignment: 0 > n.labelDistance ? "center" : n.half ? "right" : "left",
                        connectorPosition: {
                            breakAt: {x: e[0] + r + Math.cos(p) * t, y: e[1] + y + Math.sin(p) * t},
                            touchingSliceAt: {x: e[0] + r, y: e[1] + y}
                        }
                    }
                }
            ...
            redrawPoints: function () {
                var e = this, c = e.chart, a = c.renderer, b, d, f, h, k = e.options.shadow;
                this.drawEmpty();
                !k || e.shadowGroup || c.styledMode || (e.shadowGroup = a.g("shadow").attr({zIndex: -1}).add(e.group));
                e.points.forEach(function (g) {
                    ...
                    if (!g.isNull && d) {
                        ...
                        g.delayedRendering ? (d.setRadialReference(e.center).attr(h).attr(b), c.styledMode || d.attr(f).attr({"stroke-linejoin": "round"}).shadow(k, q), g.delayedRendering = !1) : (d.setRadialReference(e.center), c.styledMode || t(!0, m, f), t(!0, m, h, b), d.animate(m));
                        d.attr({visibility: g.visible ? "inherit" : "hidden"});
            ...
            init: function () {
                ...
                var a = this, b = a.series, d = b.chart, f = b.options.ignoreHiddenPoint;
                c = D(c, f);
                ...
                fixedOffset: function (e,
                    ...
                    c = c.touchingSliceAt;
                    var b = this.series, d = b.center[0], f = b.chart.plotWidth, h = b.chart.plotLeft;
                    b = e.alignment;
                ...
                var e = this.labelPosition, c = this.series.options.dataLabels, a = c.connectorShape,
                    b = this.connectorShapes;
                b[a] && (a = b[a]);
                return a.call(this, {x: e.final.x, y: e.final.y, alignment: e.alignment}, e.connectorPosition, c)
            }
        });
        ""
    });
    M(w, "parts/DataLabels.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w = f.animObject, F = f.arrayMax, A = f.clamp, D = f.defined, x = f.extend, p = f.isArray,
            H = f.objectEach, u = f.pick, t = f.relativeLength, y = f.splat, k = d.format, n = d.merge;
        f = d.noop;
        var E = d.Series, h = d.seriesTypes, e = d.stableSort;
        ...
        E.prototype.drawDataLabels = function () {
            ...
            function a(a, b) {
                ...
                if (p(a) && !p(b)) c = a.map(function (a) {
                    ...
                    return n(a, b)
                }); else if (p(a) || p(b)) for (e = Math.max(a.length,
                    b.length); e--;) c[e] = n(a[e], b[e]); else c = n(a, b);
                return c
            }

            var b = this, e = b.chart, f = b.options, h = f.dataLabels, t = b.points, z, l = b.hasRendered || 0,
                v = w(f.animation).duration, B = Math.min(v, 200), A = !e.renderer.forExport && u(h.defer, 0 < B),
                x = e.renderer;
            ...
            if (p(h) || h.enabled || b._hasPointLabels) {
                ...
                A && (r.attr({opacity: +l}), l || setTimeout(function () {
                    var a = b.dataLabelsGroup;
                    a && (b.visible && r.show(!0), a[f.animation ? "animate" : "attr"]({opacity: 1}, {duration: B}))
                }, v - B));
                t.forEach(function (d) {
                    ...
                    z.forEach(function (a, g) {
                        var h = a.enabled && (!d.isNull || d.dataLabelOnNull) && c(d, a),
                            ...
                            m = d.connectors ? d.connectors[g] : d.connector, q = u(a.distance,
                            d.labelDistance), z = !l;
                        if (h) {
                            ...
                            var C = {
                                r: a.borderRadius || 0, rotation: t, padding: a.padding,
                                zIndex: 1
                            };
        ...
        E.prototype.alignDataLabel = function (c, a, b, e, d) {
            var g = this, f = this.chart, h = this.isCartesian && f.inverted, l = this.enabledDataSorting,
                k = u(c.dlBox && c.dlBox.centerX, c.plotX, -9999), q = u(c.plotY, -9999), n = a.getBBox(),
                t = b.rotation, r = b.align, p = f.isInsidePlot(k, Math.round(q), h),
            ...
            if (A) {
                ...
                x(b, {width: n.width, height: n.height});
                t ? (y = !1, k = f.renderer.rotCorr(D, t), k = {
                    x: e.x + b.x + e.width / 2 + k.x,
                    y: e.y + b.y + {top: 0, middle: .5, bottom: 1}[b.verticalAlign] * e.height
                }, w(k), a[d ? "attr" : "animate"](k).attr({align: r}), w = (t + 720) % 360, w = 180 < w && 360 > w, "left" === r ? k.y -= w ? n.height : 0 : "center" === r ? (k.x -= n.width /
        ...
        E.prototype.setDataLabelStartPos = function (c, a, b, e, d) {
            var g = this.chart,
                f = g.inverted, h = this.xAxis, l = h.reversed, k = f ? a.height / 2 : a.width / 2;
            ...
            g.hasRendered && (b && a.attr({x: a.startXPos, y: a.startYPos}), a.placed = !0)
        };
        E.prototype.justifyDataLabel = function (c, a, b, e, d, f) {
            var g = this.chart, h = a.align, l = a.verticalAlign, m = c.box ? 0 : c.padding ||
                0;
            var k = b.x + m;
            if (0 > k) {
        ...
        h.pie && (h.pie.prototype.dataLabelPositioners = {
            ...
            var c = this, a = c.data, b, e = c.chart, f = c.options.dataLabels, h = f.connectorPadding, k,
                z = e.plotWidth,
                l = e.plotHeight, v = e.plotLeft, t = Math.round(e.chartWidth / 3), p, y = c.center, r = y[2] / 2,
                A = y[1], x, w, H, L, M = [[], []], P, K, Q, R, V = [0, 0, 0, 0], Z = c.dataLabelPositioners, X;
            c.visible && (f.enabled || c._hasPointLabels) && (a.forEach(function (a) {
                ...
                !D(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > t && (a.dataLabel.css({width: .7 * t}), a.dataLabel.shortened = !0)) : (a.dataLabel = a.dataLabel.destroy(), a.dataLabels && 1 === a.dataLabels.length && delete a.dataLabels))
                ...
                if (m) {
                    ...
                    for (R = 0; R < m; R++) {
                        ...
                        if (f.justify) P = Z.justify(b, r, y); else switch (f.alignTo) {
                            case "connectors":
                        ...
                        x._attr = {visibility: Q, align: H.alignment};
                        x._pos = {x: P + f.x + ({left: h, right: -h}[H.alignment] || 0), y: K + f.y - 10};
                        H.final.x = P;
                        H.final.y = K;
                ...
                if (k = u(X.connectorWidth, 1)) {
                    ...
                    if ((x = a.dataLabel) && x._pos && a.visible && 0 < a.labelDistance) {
                        ...
                        p[b ? "attr" : "animate"]({d: a.getConnectorPath()});
                        p.attr("visibility", Q)
            ...
            this.points.forEach(function (c) {
                ...
                a && c.visible && ((b = a._pos) ? (a.sideOverflow && (a._attr.width = Math.max(a.getBBox().width - a.sideOverflow, 0), a.css({
                    width: a._attr.width + "px", textOverflow: (this.options.dataLabels.style ||
                        {}).textOverflow || "ellipsis"
                }), a.shortened = !0), a.attr(a._attr), a[a.moved ? "animate" : "attr"](b), a.moved = !0) : a && a.attr({y: -9999}));
                delete c.distributeBox
            }, this)
        }, h.pie.prototype.alignDataLabel = f, h.pie.prototype.verifyDataLabelOverflow = function (c) {
            var a = this.center, b = this.options, e = b.center, d = b.minSize || 80, f = null !== b.size;
            if (!f) {
                if (null !== e[0]) var h = Math.max(a[2] - Math.max(c[1], c[3]), d); else h = Math.max(a[2] - c[1] - c[3], d), a[0] += (c[3] - c[1]) / 2;
        ...
        h.column && (h.column.prototype.alignDataLabel = function (c, a, b, e, d) {
            var f = this.chart.inverted, g = c.series, h = c.dlBox || c.shapeArgs,
            ...
            h && (e = n(h), 0 > e.y && (e.height += e.y, e.y = 0), h = e.y + e.height - g.yAxis.len, 0 < h && (e.height -= h), f && (e = {
                ...
                y: g.xAxis.len - e.x - e.width, width: e.height, height: e.width
            ...
            b.inside && c.contrastColor && a.css({color: c.contrastColor})
        })
    });
    M(w, "modules/overlapping-datalabels.src.js", [w["parts/Globals.js"],
        w["parts/Utilities.js"]], function (d, f) {
        var w = f.isArray, F = f.objectEach, A = f.pick;
        f = d.Chart;
        var D = d.addEvent, x = d.fireEvent;
        D(f, "render", function () {
            var d = [];
        ...
        f.prototype.hideOverlappingLabels = function (d) {
            var f = this, p = d.length, t = f.renderer, y, k, n, A = !1;
            var h = function (a) {
            ...
            for (k = 0; k < p; k++) if (y = d[k]) y.oldOpacity = y.opacity, y.newOpacity = 1, y.absoluteBox = h(y);
            d.sort(function (a, b) {
            ...
            d.forEach(function (a) {
                ...
                if (a) {
                    ...
                    a.oldOpacity !== c && (a.alignAttr && a.placed ? (c ? a.show(!0) : b = function () {
                        a.hide(!0);
                        a.placed = !1
                    }, A = !0, a.alignAttr.opacity = c, a[a.isOld ? "animate" : "attr"](a.alignAttr, null, b), x(f, "afterHideOverlappingLabel")) : a.attr({opacity: c}));
                    a.isOld = !0
                }
            });
    ...
    M(w, "parts/Interaction.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w =
            f.defined, F = f.extend, A = f.isArray, D = f.isObject, x = f.objectEach, p = f.pick, H = d.addEvent;
        f = d.Chart;
        var u = d.createElement, t = d.css, y = d.defaultOptions, k = d.defaultPlotOptions, n = d.fireEvent,
            E = d.hasTouch, h = d.Legend, e = d.merge, c = d.Point, a = d.Series, b = d.seriesTypes, g = d.svg;
            ...
            drawTrackerPoint: function () {
                ...
                a._hasTracking || (a.trackerGroups.forEach(function (d) {
                    if (a[d]) {
                        ...
                        !b.styledMode && a.options.cursor && a[d].css(t).css({cursor: a.options.cursor})
                    }
                }), a._hasTracking = !0);
                n(this, "afterDrawTracker")
            }, drawTrackerGraph: function () {
                var a = this, b = a.options,
                    c = b.trackByArea, e = [].concat(c ? a.areaPath : a.graphPath), d = e.length, f = a.chart,
                    h = f.pointer, k = f.renderer, q = f.options.tooltip.snap, t = a.tracker, p, y = function () {
                        if (f.hoverSeries !== a) a.onMouseOver()
                    }, u = "rgba(192,192,192," + (g ? .0001 : .002) + ")";
                if (d && !c) for (p = d + 1; p--;) "M" === e[p] && e.splice(p + 1, 0, e[p + 1] - q, e[p + 2], "L"), (p && "M" === e[p] || p === d) && e.splice(p, 0, "L", e[p - 2] + q, e[p - 1]);
                t ? t.attr({d: e}) : a.graph && (a.tracker = k.path(e).attr({
        ...
        F(h.prototype, {
            setItemEvents: function (a, b, d) {
                var f = this, g = f.chart.renderer.boxWrapper, h = a instanceof c,
                    k = "highcharts-legend-" + (h ? "point" : "series") + "-active", m = f.chart.styledMode;
        ...
        F(f.prototype, {
            showResetZoom: function () {
                ...
                var b = this, c = y.lang, e = b.options.chart.resetZoomButton, d = e.theme, f = d.states,
                ...
                var b = this, c, e = b.pointer, d = !1, f = b.inverted ? e.mouseDownX : e.mouseDownY;
                !a || a.resetSelection ? (b.axes.forEach(function (a) {
                    ...
                    var g = a.axis, h = b.inverted ? g.left : g.top, l = b.inverted ?
                        h + g.width : h + g.height, k = g.isXAxis, m = !1;
                ...
                var c = this, e = c.hoverPoints, d = c.options.chart, f;
                ...
                n(this, "pan", {originalEvent: a}, function () {
                    ...
                    "xy" === g ? b = [1, 0] : "y" === g && (b = [0]);
                    b.forEach(function (b) {
                        var e = c[b ? "xAxis" : "yAxis"][0], d = e.options, g = e.horiz, h = a[g ? "chartX" : "chartY"];
                        g = g ? "mouseDownX" : "mouseDownY";
                        var l = c[g], k = (e.pointRange || 0) / 2,
                            m = e.reversed && !c.inverted || !e.reversed && c.inverted ? -1 : 1, q = e.getExtremes(),
                        ...
                        if (!d.ordinal) {
                            ...
                            if (e.series.length && l !== q.min && r !== q.max && b || e.panningState && l >= e.panningState.startMin && r <= e.panningState.startMax) e.setExtremes(l, r, !1, !1, {trigger: "pan"}), f = !0;
                            c[g] = h
                        }
                    });
                    f && c.redraw(!1);
                    t(c.container, {cursor: "move"})
                })
            }
        });
        F(c.prototype, {
            select: function (a, b) {
                var c = this, e = c.series, d = e.chart;
                ...
                if (!this.hasImportedEvents) {
                    var a = this, b = e(a.series.options.point, a.options).events;
                    a.events = b;
                    x(b, function (b, c) {
                ...
                var c = this.series, e = this.state, d = c.options.states[a ||
                    "normal"] || {}, f = k[c.type].marker && c.options.marker, g = f && !1 === f.enabled,
                    h = f && f.states && f.states[a || "normal"] || {}, m = !1 === h.enabled, q = c.stateMarkerGraphic,
                    t = this.marker || {}, y = c.chart, u = c.halo, A, C = f && c.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === d.enabled || a && (m || g && !1 === h.enabled) || a && t.states && t.states[a] && !1 === t.states[a].enabled)) {
                    ...
                    if (this.graphic) {
                        ...
                        if (!y.styledMode) {
                            ...
                            c.options.inactiveOtherPoints && ((this.dataLabels || []).forEach(function (a) {
                                a && a.animate({opacity: x.opacity}, w)
                            }), this.connector && this.connector.animate({opacity: x.opacity}, w));
                    ...
                    a && a.size && q && "hidden" !== d && !this.isCluster ? (u || (c.halo = u = y.renderer.path().add(q.parentGroup)), u.show()[b ? "animate" : "attr"]({d: this.haloPath(a.size)}), u.attr({
                        "class": "highcharts-halo highcharts-color-" + p(this.colorIndex,
                            c.colorIndex) + (this.className ? " " + this.className : ""), visibility: d, zIndex: -1
        ...
        F(a.prototype, {
            onMouseOver: function () {
                ...
                var c = this, e = c.options, d = c.graph, f = e.inactiveOtherPoints, g = e.states, h = e.lineWidth,
                    k = e.opacity, m = p(g[a ||
                ...
                if (c.state !== a && ([c.group, c.markerGroup, c.dataLabelsGroup].forEach(function (b) {
                    ...
                    if (d && !d.dashstyle) for (g = {"stroke-width": h}, d.animate(g, m); c["zone-graph-" + e];) c["zone-graph-" + e].attr(g), e +=
                        1;
                ...
                var c = this, e = c.chart, d = c.legendItem, f = e.options.chart.ignoreHiddenSeries, g = c.visible;
    ...
    M(w, "parts/Responsive.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w = f.isArray, F = f.isObject, A = f.objectEach, D = f.pick, x = f.splat;
        f = d.Chart;
        f.prototype.setResponsive = function (f, A) {
            var p = this.options.responsive, t = [], y = this.currentResponsive;
        ...
        f.prototype.currentOptions = function (d) {
            function f(d, k, n, t) {
                var h;
                A(d, function (e, c) {
                    if (!t && -1 < p.collectionsWithUpdate.indexOf(c)) for (e = x(e), n[c] = [], h = 0; h < e.length; h++) k[c][h] && (n[c][h] = {}, f(e[h], k[c][h], n[c][h], t + 1)); else F(e) ? (n[c] = w(e) ? [] : {}, f(e, k[c] || {}, n[c], t + 1)) : n[c] = "undefined" === typeof k[c] ? null : k[c]
                })
            }
    ...
    M(w, "parts-map/ColorSeriesMixin.js",
        [w["parts/Globals.js"]], function (d) {
            d.colorPointMixin = {
                setVisible: function (d) {
                    var f = this, w = d ? "show" : "hide";
            ...
            d.colorSeriesMixin = {
                optionalAxis: "colorAxis", colorAxis: 0, translateColors: function () {
                    var d = this, w = this.options.nullColor, F = this.colorAxis, A = this.colorKey;
    ...
    M(w, "parts-map/ColorAxis.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w = f.erase, F = f.extend, A = f.isNumber, D = f.pick, x = f.splat;
        f = d.addEvent;
        var p = d.Axis, H = d.Chart, u = d.Series, t = d.Point, y = d.color, k = d.Legend, n = d.LegendSymbolMixin,
            E = d.colorPointMixin, h = d.noop, e = d.merge;
        ...
        F(c.prototype, {
            ...
            initDataClasses: function (a) {
                var b = this.chart, c, d = 0, f = b.options.chart.colorCount, h = this.options,
            ...
            buildOptions: function (a, b) {
                var c = this.options.legend, d = b.layout ? "vertical" !== b.layout : "vertical" !== c.layout;
                return e(a, {side: d ? 2 : 1, reversed: !d}, b, {
                    opposite: !d,
                    showEmpty: !1,
                    title: null,
            ...
            setAxisSize: function () {
                var a = this.legendSymbol, b = this.chart, c = b.options.legend || {}, e, d;
            ...
            toColor: function (a, b) {
                var c = this.stops, e = this.dataClasses, d;
            ...
            setLegendColor: function () {
                ...
                this.legendColor = {linearGradient: {x1: b[0], y1: b[1], x2: b[2], y2: b[3]}, stops: this.stops}
            },
            drawLegendSymbol: function (a, b) {
                var c = a.padding, e = a.options, d = this.horiz,
                    f = D(e.symbolWidth, d ? this.defaultLegendLength : 12),
                    h = D(e.symbolHeight, d ? 12 : this.defaultLegendLength), k = D(e.labelPadding, d ? 16 : 30);
                e = D(e.itemDistance, 10);
                this.setLegendColor();
                b.legendSymbol = this.chart.renderer.rect(0, a.baseline - 11, f, h).attr({zIndex: 1}).add(b.legendGroup);
            ...
            setVisible: h,
            getSeriesExtremes: function () {
                var a = this.series, b = a.length, c;
                ...
                for (this.dataMax = -Infinity; b--;) {
                    ...
                    if (e[d + "Data"]) var k = e[d + "Data"]; else if (f) {
                        k = [];
                        f = f.indexOf(d);
                        var n = e.yData;
                        if (0 <= f && n) for (c = 0; c < n.length; c++) k.push(D(n[c][f],
                            n[c]))
                    } else k = e.yData;
            ...
            drawCrosshair: function (a, b) {
                var c = b && b.plotX, e = b && b.plotY, d = this.pos, f = this.len;
                if (b) {
                    ...
                    b.plotX = c;
                    b.plotY = e;
                    this.cross && !this.cross.addedToColorAxis && this.legendGroup && (this.cross.addClass("highcharts-coloraxis-marker").add(this.legendGroup), this.cross.addedToColorAxis = !0, this.chart.styledMode || this.cross.attr({fill: this.crosshair.color}))
                }
            },
            getPlotLinePath: function (a) {
                ...
                6, b - 6, "Z"] : p.prototype.getPlotLinePath.apply(this, arguments)
            },
            update: function (a, b) {
                var c = this.chart, d = c.legend, f = this.buildOptions.call(c, {}, a);
                this.series.forEach(function (a) {
                    a.isDirtyData = !0
                });
            ...
            getDataClassLegendSymbols: function () {
                var a = this, b = this.chart, c = this.legendItems, e = b.options.legend, d = e.valueDecimals,
                    f = e.valueSuffix || "", k;
                c.length || this.dataClasses.forEach(function (e, g) {
                    var l = !0, m = e.from, q = e.to, r = b.numberFormatter;
                    k = "";
    ...
    M(w, "parts-map/MapNavigation.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        function w(d) {
            d && (d.preventDefault && d.preventDefault(), d.stopPropagation && d.stopPropagation(), d.cancelBubble =
                !0)
        }
        ...
        var A = f.extend, D = f.objectEach, x = f.pick, p = d.addEvent;
        f = d.Chart;
        var H = d.doc, u = d.merge;
        F.prototype.init = function (d) {
            this.chart = d;
            d.mapNavButtons = []
        };
        F.prototype.update = function (d) {
            var f = this.chart, k = f.options.mapNavigation, n, t, h, e, c, a = function (a) {
            ...
            x(k.enableButtons, k.enabled) && !f.renderer.forExport && D(k.buttons, function (d, q) {
                ...
                d.handler = n.onclick;
                d.align(A(n, {width: d.width, height: 2 * d.height}), null, n.alignTo);
        ...
        A(f.prototype, {
            fitToBox: function (d, f) {
                ...
                var h = this.xAxis[0], e = h.max - h.min, c = x(f, h.min + e / 2), a = e * d;
                e = this.yAxis[0];
                var b = e.max - e.min, g = x(k, e.min + b / 2);
                b *= d;
                c = this.fitToBox({
                    x: c - a * (n ? (n - h.pos) /
                        h.len : .5), y: g - b * (p ? (p - e.pos) / e.len : .5), width: a, height: b
                }, {x: h.dataMin, y: e.dataMin, width: h.dataMax - h.dataMin, height: e.dataMax - e.dataMin});
    ...
    M(w, "parts-map/MapSeries.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w = f.extend, F = f.isArray, A = f.isNumber, D = f.objectEach, x = f.pick, p = f.splat;
        f = d.colorMapPointMixin;
        var H = d.merge, u = d.noop, t = d.fireEvent, y = d.Point,
            k = d.Series, n = d.seriesType, E = d.seriesTypes;
        n("map", "scatter", {
                animation: !1,
                dataLabels: {
            ...
            H(d.colorMapSeriesMixin, {
                ...
                getBox: function (f) {
                    var e = Number.MAX_VALUE, c = -e, a = e, b = -e, g = e, h = e, k = this.xAxis, n = this.yAxis, p;
                    (f || []).forEach(function (f) {
                        if (f.path) {
                            "string" === typeof f.path && (f.path = d.splitPath(f.path));
                            var k = f.path ||
                                [], l = k.length, m = !1, q = -e, n = e, t = -e, u = e, y = f.properties;
                            if (!f._foundBox) {
                ...
                translatePath: function (d) {
                    var e = !1, c = this.xAxis, a = this.yAxis, b = c.min, f = c.transA;
                    c = c.minPixelPadding;
                    var h = a.min, k = a.transA;
                    a = a.minPixelPadding;
                    var n, p = [];
                    if (d) for (n = d.length; n--;) A(d[n]) ? (p[n] = e ? (d[n] - b) * f + c : (d[n] - h) * k + a, e = !e) : p[n] = d[n];
                    return p
                },
                setData: function (f, e, c, a) {
                    var b = this.options, g = this.chart.options.chart, h = g && g.map,
                        m = b.mapData, n = this.joinBy, p = b.keys || this.pointArrayMap, l = [], t = {},
                        u = this.chart.mapTransforms;
                    !m && h && (m = "string" === typeof h ? d.maps[h] : h);
                    f && f.forEach(function (a, c) {
                        var e = 0;
                        if (A(a)) f[c] = {value: a}; else if (F(a)) {
                            f[c] = {};
                    ...
                    if (m) {
                        ...
                        b.allAreas ? (this.getBox(m), f = f || [], n[1] && f.forEach(function (a) {
                            ...
                            n[0] && -1 !== l.indexOf("|" + b[n[0]] + "|") || (f.push(H(b, {value: null})), a = !1)
                        })) : this.getBox(l)
                    }
                ...
                translate: function () {
                    var d = this, e = d.xAxis, c = d.yAxis, a = d.doFullTranslate();
                    d.generatePoints();
                    d.data.forEach(function (b) {
                        A(b._midX) && A(b._midY) &&
                        (b.plotX = e.toPixels(b._midX, !0), b.plotY = c.toPixels(b._midY, !0));
                        a && (b.shapeType = "path", b.shapeArgs = {d: d.translatePath(b.path)})
                    });
                    t(d, "afterTranslate")
                },
                ...
                drawPoints: function () {
                    var d = this, e = d.xAxis, c = d.yAxis, a = d.group, b = d.chart, f = b.renderer,
                        k = this.baseTrans;
                    ...
                    if (d.doFullTranslate()) b.hasRendered && !b.styledMode && d.points.forEach(function (a) {
                        ...
                        if (b.renderer.globalAnimation) {
                            ...
                            var w = t.attr("scaleX");
                            var r = t.attr("scaleY");
                            t.attr({animator: 0}).animate({animator: 1}, {
                                step: function (a, b) {
                                    t.attr({
                        ...
                        } else t.attr({translateX: p, translateY: l, scaleX: m, scaleY: n})
                    }
                ...
                render: function () {
                    var d = this, e = k.prototype.render;
                    d.chart.renderer.isVML && 3E3 < d.data.length ? setTimeout(function () {
                        e.call(d)
                    }) : e.call(d)
                },
                animate: function (d) {
                    var e = this.options.animation, c = this.group, a = this.xAxis, b = this.yAxis, f = a.pos,
                        h = b.pos;
                    this.chart.renderer.isSVG && (!0 === e && (e = {duration: 1E3}), d ? c.attr({
                        translateX: f + a.len / 2,
                        translateY: h + b.len / 2,
                        scaleX: .001,
                        scaleY: .001
                    }) : (c.animate({translateX: f, translateY: h, scaleX: 1, scaleY: 1}, e), this.animate = null))
                },
                animateDrilldown: function (d) {
                    var e = this.chart.plotBox, c = this.chart.drilldownLevels[this.chart.drilldownLevels.length - 1],
                        a = c.bBox, b = this.chart.options.drilldown.animation;
                    d || (d = Math.min(a.width / e.width, a.height / e.height), c.shapeArgs = {
                        ...
                        a.graphic &&
                        a.graphic.attr(c.shapeArgs).animate({scaleX: 1, scaleY: 1, translateX: 0, translateY: 0}, b)
                    }), this.animate = null)
                },
                drawLegendSymbol: d.LegendSymbolMixin.drawRectangle,
                ...
                applyOptions: function (d, e) {
                    ...
                    if (null !== this.value || this.series.options.nullInteraction) y.prototype.onMouseOver.call(this, f); else this.series.onMouseOut(f)
                }, zoomTo: function () {
                    var d = this.series;
    ...
    M(w, "parts-map/MapLineSeries.js", [w["parts/Globals.js"]], function (d) {
        var f = d.seriesType, w = d.seriesTypes;
        f("mapline", "map", {lineWidth: 1, fillColor: "none"}, {
            type: "mapline",
            colorProp: "stroke",
    ...
    M(w, "parts-map/MapPointSeries.js", [w["parts/Globals.js"]], function (d) {
        var f = d.merge, w = d.Point, F = d.Series;
        d = d.seriesType;
        d("mappoint", "scatter", {
            dataLabels: {
                crop: !1, defer: !1, enabled: !0,
                formatter: function () {
                    return this.point.name
                }, overflow: !1, style: {color: "#000000"}
            }
        }, {
            type: "mappoint", forceDL: !0, drawDataLabels: function () {
    ...
    M(w, "parts-more/BubbleLegend.js", [w["parts/Globals.js"], w["parts/Utilities.js"]],
        function (d, f) {
            var w = f.arrayMax, F = f.arrayMin, A = f.isNumber, D = f.objectEach, x = f.pick;
            f = f.wrap;
            var p = d.Series, H = d.Legend, u = d.Chart, t = d.addEvent, y = d.color, k = d.merge, n = d.noop,
                E = d.stableSort, h = d.setOptions;
            h({
                legend: {
                    bubbleLegend: {
                        borderColor: void 0,
            ...
            d.BubbleLegend.prototype = {
                init: function (d, c) {
                    ...
                    this.chart = c.chart;
                    this.legend = c
                }, setState: n, addToLegend: function (d) {
                    d.splice(this.options.legendIndex, 0, this)
                }, drawLegendSymbol: function (d) {
                    var c = this.chart, a = this.options, b = x(d.options.itemDistance,
                        20), e = a.ranges;
                    ...
                    var d =
                            this.ranges, c = this.options, a = this.chart.series[c.seriesIndex], b = this.legend.baseline,
                        f = {"z-index": c.zIndex, "stroke-width": c.borderWidth},
                        h = {"z-index": c.zIndex, "stroke-width": c.connectorWidth}, m = this.getLabelStyles(),
                        n = a.options.marker.fillOpacity, p = this.chart.styledMode;
                    d.forEach(function (e, g) {
                        ...
                        d[g] = k(d[g], {center: d[0].radius - d[g].radius + b});
                        p || k(!0, d[g], {bubbleStyle: k(!1, f), connectorStyle: k(!1, h), labelStyle: m})
                    }, this)
                }, getLabelStyles: function () {
                    var d = this.options, c = {}, a = "left" === d.labels.align, b = this.legend.options.rtl;
                    ...
                    var d = this.chart.renderer, c = this.options.zThreshold;
                    ...
                    var c = this.options, a = c.labels, b = this.chart.renderer, e = this.symbols, f = e.labels,
                        h = d.center, k = Math.abs(d.radius), n = c.connectorDistance, l = a.align,
                        p = a.style.fontSize;
                    n = this.legend.options.rtl || "left" === l ? -n : n;
                    a = c.connectorWidth;
                    var t = this.ranges[0].radius, u = h - k - c.borderWidth / 2 + a / 2;
                    ...
                    var c = this.options, a = c.labels.formatter;
                    c = c.labels.format;
                    ...
                    var d = this.legend.bubbleLegend, c = d.options.ranges, a, b = Number.MAX_VALUE,
                        f = -Number.MAX_VALUE;
                    ...
                    var h = b === f ? [{value: f}] : [{value: b}, {value: (b + f) / 2}, {value: f, autoRanges: !0}];
                    ...
                    var d = this.chart, c = this.fontMetrics, a = d.legend.options, b = "horizontal" === a.layout,
                        f = b ? d.legend.lastLineHeight : 0, h = d.plotSizeX, k = d.plotSizeY,
                        n = d.series[this.options.seriesIndex];
                    d = Math.ceil(n.minPxSize);
                    var p = Math.ceil(n.maxPxSize);
                    n = n.options.maxSize;
                    var l = Math.min(k, h);
                    if (a.floating || !/%$/.test(n)) c = p; else if (n = parseFloat(n), c = (l + f - c.h / 2) * n / 100 / (n / 100 + 1), b && k - c >= h || !b && h - c >= k) c = p;
                    ...
                    var d = this.legend, c = this.chart.series[this.options.seriesIndex];
            ...
            t(d.Legend, "afterGetAllItems",
                function (e) {
                    var c = this.bubbleLegend, a = this.options, b = a.bubbleLegend,
            ...
            H.prototype.getLinesHeights = function () {
                var d = this.allItems, c = [], a = d.length, b, f = 0;
                for (b = 0; b < a; b++) if (d[b].legendItemHeight && (d[b].itemHeight = d[b].legendItemHeight), d[b] === d[a - 1] || d[b + 1] && d[b]._legendItemPos[1] !== d[b + 1]._legendItemPos[1]) {
                    c.push({height: 0});
                    var h = c[c.length - 1];
            ...
            H.prototype.retranslateItems = function (d) {
                var c, a, b, e = this.options.rtl, f = 0;
                this.allItems.forEach(function (g, h) {
                    c = g.legendGroup.translateX;
                    a = g._legendItemPos[1];
                    if ((b = g.movementX) || e && g.ranges) b = e ? c - g.options.maxSize / 2 : c + b, g.legendGroup.attr({translateX: b});
                    h > d[f].step && f++;
                    g.legendGroup.attr({translateY: Math.round(a + d[f].height / 2)});
                    g._legendItemPos[1] = a + d[f].height / 2
                })
            };
            t(p, "legendItemClick", function () {
                var d = this.chart, c = this.visible, a = this.chart.legend;
                a && a.bubbleLegend && (this.visible = !c, this.ignoreSeries = c, d = 0 <= d.getVisibleBubbleSeriesIndex(), a.bubbleLegend.visible !== d && (a.update({bubbleLegend: {enabled: d}}), a.bubbleLegend.visible =
                    d), this.visible = c)
            });
            f(u.prototype, "drawChartBox", function (d, c, a) {
                var b = this.legend, e = 0 <= this.getVisibleBubbleSeriesIndex();
    ...
    M(w, "parts-more/BubbleSeries.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        var w = f.arrayMax, F = f.arrayMin, A = f.clamp, D = f.extend, x = f.isNumber, p = f.pick, H = f.pInt;
        f = d.Axis;
        var u = d.color,
            t = d.noop, y = d.Point, k = d.Series, n = d.seriesType, E = d.seriesTypes;
        n("bubble", "scatter", {
            dataLabels: {
                formatter: function () {
                    return this.point.z
            ...
            getRadii: function (d, e, c) {
                var a = this.zData, b = this.yData, f = c.minPxSize, h = c.maxPxSize, k = [];
                var n = 0;
            ...
            getRadius: function (d, e, c, a, b, f) {
                var g = this.options, h = "width" !== g.sizeBy, k = g.zThreshold, n = e - d, l = .5;
            ...
            animate: function (d) {
                !d && this.points.length < this.options.animationLimit && (this.points.forEach(function (d) {
                    var c = d.graphic;
                    if (c && c.width) {
                        var a = {x: c.x, y: c.y, width: c.width, height: c.height};
                        c.attr({
                            x: d.plotX,
                            y: d.plotY, width: 1, height: 1
                        });
            ...
            translate: function () {
                var d, e = this.data, c = this.radii;
        ...
        f.prototype.beforePadding = function () {
            var d = this, e = this.len, c = this.chart, a = 0, b = e, f = this.isXAxis, k = f ? "xData" : "yData",
                m = this.min, n = {}, t = Math.min(c.plotWidth, c.plotHeight), l = Number.MAX_VALUE,
                u = -Number.MAX_VALUE, y = this.max - m, E = e / y, D = [];
            this.series.forEach(function (a) {
                var b = a.options;
                !a.bubblePadding || !a.visible && c.options.chart.ignoreHiddenSeries || (d.allowZoomOutside =
                    !0, D.push(a), f && (["minSize", "maxSize"].forEach(function (a) {
                    var c = b[a], d = /%$/.test(c);
                    c = H(c);
                    n[a] = d ? t * c / 100 : c
            ...
            D.forEach(function (c) {
                var e = c[k], g = e.length;
                f && c.getRadii(l, u, c);
                if (0 < y) for (; g--;) if (x(e[g]) && d.dataMin <= e[g] && e[g] <= d.max) {
            ...
            D.length && 0 < y && !this.isLog && (b -= e, E *= (e + Math.max(0, a) - Math.min(b, e)) / e, [["min", "userMin", a], ["max", "userMax", b]].forEach(function (a) {
    ...
    M(w, "parts-map/MapBubbleSeries.js", [w["parts/Globals.js"]], function (d) {
        var f = d.merge, w = d.Point, F = d.seriesType, A = d.seriesTypes;
        A.bubble && F("mapbubble", "bubble", {animationLimit: 500, tooltip: {pointFormat: "{point.name}: {point.z}"}}, {
            xyFromShape: !0,
            type: "mapbubble",
            pointArrayMap: ["z"],
    ...
    M(w, "parts-map/HeatmapSeries.js", [w["parts/Globals.js"],
        w["parts/Utilities.js"]], function (d, f) {
        var w = f.clamp, F = f.extend, A = f.pick;
        f = d.colorMapPointMixin;
        var D = d.merge, x = d.noop, p = d.fireEvent, H = d.Series, u = d.seriesType, t = d.seriesTypes;
        u("heatmap", "scatter", {
            animation: !1,
            borderWidth: 0,
            nullColor: "#f7f7f7",
        ...
        }, D(d.colorMapSeriesMixin,
            {
                ...
                translate: function () {
                    var d = this.options, f = this.xAxis, n = this.yAxis, t = d.pointPadding || 0,
                        h = this.pointPlacementToXValue();
                    this.generatePoints();
                    this.points.forEach(function (e) {
                        var c = (d.colsize || 1) / 2, a = (d.rowsize || 1) / 2,
    ...
    M(w, "parts-map/GeoJSON.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        ...
        var F = f.extend;
        f = f.wrap;
        var A = d.Chart, D = d.format, x = d.merge, p = d.win;
        A.prototype.transformFromLatLon = function (f, u) {
            if ("undefined" === typeof p.proj4) return d.error(21, !1, this), {x: 0, y: null};
        ...
        A.prototype.transformToLatLon = function (f, u) {
            if ("undefined" === typeof p.proj4) d.error(21, !1, this); else {
                f = {
                ...
                var t = u.cosAngle || u.rotation && Math.cos(u.rotation),
                    y = u.sinAngle || u.rotation && Math.sin(u.rotation);
                u = p.proj4(u.crs, "WGS84", u.rotation ? {x: f.x * t + f.y * -y, y: f.x * y + f.y * t} : f);
                return {lat: u.y, lon: u.x}
            }
        };
        A.prototype.fromPointToLatLon = function (f) {
            var p = this.mapTransforms, t;
            if (p) {
                for (t in p) if (Object.hasOwnProperty.call(p, t) && p[t].hitZone && w({
                    x: f.x,
                    y: -f.y
        ...
        A.prototype.fromLatLonToPoint = function (f) {
            var p = this.mapTransforms, t;
            if (!p) return d.error(22, !1, this), {x: 0, y: null};
            for (t in p) if (Object.hasOwnProperty.call(p, t) && p[t].hitZone) {
                var y = this.transformFromLatLon(f, p[t]);
                if (w({x: y.x, y: -y.y}, p[t].hitZone.coordinates[0])) return y
            }
            return this.transformFromLatLon(f, p["default"])
        };
        d.geojson = function (d, f, p) {
            var t = [], k = [], n = function (d) {
                var f, e = d.length;
                k.push("M");
            ...
            d.features.forEach(function (d) {
                ...
                k.length && (c = {path: k})) : "mapline" === f ? ("LineString" === e ? n(h) : "MultiLineString" === e && h.forEach(n), k.length && (c = {path: k})) : "mappoint" === f && "Point" === e && (c = {
                    x: h[0],
                    y: -h[1]
                });
                c && t.push(F(c, {name: d.name || d.NAME, properties: d}))
            });
            p && d.copyrightShort && (p.chart.mapCredits = D(p.chart.options.credits.mapText, {geojson: d}), p.chart.mapCreditsFull = D(p.chart.options.credits.mapTextFull, {geojson: d}));
            return t
        };
    ...
    M(w, "parts-map/Map.js", [w["parts/Globals.js"], w["parts/Utilities.js"]], function (d, f) {
        ...
        var F = f.extend, A = f.pick, D = d.Chart;
        f = d.defaultOptions;
        var x = d.merge, p = d.Renderer, H = d.SVGRenderer, u = d.VMLRenderer;
        F(f.lang, {zoomIn: "Zoom in", zoomOut: "Zoom out"});
        f.mapNavigation = {
            buttonOptions: {
                alignTo: "plotBox",
                align: "left",
        ...
        d.Map = d.mapChart = function (f, p, k) {
            var n = "string" === typeof f || f.nodeName, t = arguments[n ? 1 : 0], h = t, e = {
                endOnTick: !1, visible: !1,
                minPadding: 0, maxPadding: 0, startOnTick: !1
            ...
            t = x({
                ...
                xAxis: e,
                yAxis: x(e, {reversed: !0})
            }, t, {chart: {inverted: !1, alignTicks: !1}});
            t.series = h.series = a;
    ...
    M(w, "masters/highmaps.src.js",
        [w["masters/highcharts.src.js"]], function (d) {
            d.product = "Highmaps";
            return d
        });
